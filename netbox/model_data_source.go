...
type DataSource struct {
	...
	SyncInterval NullableInt32 `json:"sync_interval,omitempty"`
...
func NewDataSource(id int32) *DataSource {
	this := DataSource{}
	this.Id = id
	return &this
}
...
func (o *DataSource) GetType() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *DataSource) GetTypeOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *DataSource) SetType(v ChoiceString) {
	o.Type = &v
}
...
func (o *DataSource) HasSourceUrl() bool {
	if o != nil && !IsNil(o.SourceUrl) {
		return true
	}
...
func (o *DataSource) GetStatus() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *DataSource) GetStatusOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *DataSource) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *DataSource) SetStatus(v ChoiceString) {
	o.Status = &v
}
...
func (o *DataSource) GetSyncInterval() int32 {
...
func (o *DataSource) GetSyncIntervalOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
// SetSyncInterval gets a reference to the given NullableInt32 and assigns it to the SyncInterval field.
func (o *DataSource) SetSyncInterval(v int32) {
