...
type WritableCustomFieldRequest struct {
	...
	// The type of data this custom field holds  * `text` - Text * `longtext` - Text (long) * `integer` - Integer * `decimal` - Decimal * `boolean` - Boolean * `date` - Date * `datetime` - Date & time * `url` - URL * `json` - JSON * `select` - Selection * `multiselect` - Multiple selection * `object` - Object * `multiobject` - Multiple objects
...
func (o *WritableCustomFieldRequest) GetNullsFirst() bool {
...
// and a boolean to check if the value has been set.
func (o *WritableCustomFieldRequest) GetNullsFirstOk() (*bool, bool) {
	if o == nil || IsNil(o.NullsFirst) {
		return nil, false
	}
...
func (o *WritableCustomFieldRequest) HasNullsFirst() bool {
	if o != nil && !IsNil(o.NullsFirst) {
		return true
	}
...
func (o *WritableCustomFieldRequest) SetNullsFirst(v bool) {
	o.NullsFirst = &v
}
...
func (o *WritableCustomFieldRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WritableCustomFieldRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableCustomFieldRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
