...
type Site struct {
	...
	Asns                 []BriefASN             `json:"asns,omitempty"`
...
func (o *Site) GetStatus() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *Site) GetStatusOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *Site) SetStatus(v ChoiceString) {
	o.Status = &v
}
...
// SetAsns gets a reference to the given []BriefASN and assigns it to the Asns field.
