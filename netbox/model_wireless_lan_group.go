...
func NewWirelessLANGroup(id int32) *WirelessLANGroup {
...
func (o *WirelessLANGroup) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *WirelessLANGroup) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *WirelessLANGroup) HasSlug() bool {
	if o != nil && !IsNil(o.Slug) {
		return true
	}
...
func (o *WirelessLANGroup) HasDepth() bool {
	if o != nil && !IsNil(o.Depth) {
		return true
	}
