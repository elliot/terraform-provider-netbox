...
func NewPrefix(id int32) *Prefix {
	this := Prefix{}
	this.Id = id
	return &this
}
...
func (o *Prefix) GetFamily() ChoiceInteger {
...
// and a boolean to check if the value has been set.
func (o *Prefix) GetFamilyOk() (*ChoiceInteger, bool) {
	if o == nil || IsNil(o.Family) {
		return nil, false
	}
...
func (o *Prefix) SetFamily(v ChoiceInteger) {
	o.Family = &v
}
...
func (o *Prefix) GetStatus() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *Prefix) GetStatusOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *Prefix) SetStatus(v ChoiceString) {
	o.Status = &v
}
