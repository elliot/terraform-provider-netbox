...
type Service struct {
	...
	Protocol NullableChoiceString `json:"protocol,omitempty"`
	// Deprecated; use port_mappings. Reported only for single-protocol services.
	Ports                []int32                `json:"ports,omitempty"`
	Ipaddresses          []BriefIPAddress       `json:"ipaddresses,omitempty"`
...
func NewService(id int32) *Service {
	this := Service{}
	this.Id = id
	return &this
}
...
func (o *Service) HasParentObjectType() bool {
	if o != nil && !IsNil(o.ParentObjectType) {
		return true
	}
...
func (o *Service) HasParentObjectId() bool {
	if o != nil && !IsNil(o.ParentObjectId) {
		return true
	}
...
func (o *Service) GetProtocol() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Service) GetProtocolOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
// SetProtocol gets a reference to the given NullableChoiceString and assigns it to the Protocol field.
func (o *Service) SetProtocol(v ChoiceString) {
	o.Protocol.Set(&v)
}

// SetProtocolNil sets the value for Protocol to be an explicit nil
func (o *Service) SetProtocolNil() {
	o.Protocol.Set(nil)
}
...
// SetIpaddresses gets a reference to the given []BriefIPAddress and assigns it to the Ipaddresses field.
