...
func NewConsolePort(id int32) *ConsolePort {
	this := ConsolePort{}
	this.Id = id
	return &this
}
...
func (o *ConsolePort) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ConsolePort) GetType() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *ConsolePort) GetTypeOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ConsolePort) GetSpeedOk() (*ChoiceInteger, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ConsolePort) SetSpeed(v ChoiceInteger) {
	o.Speed.Set(&v)
}
...
func (o *ConsolePort) HasLinkPeers() bool {
	if o != nil && !IsNil(o.LinkPeers) {
		return true
	}
...
func (o *ConsolePort) HasConnectedEndpointsReachable() bool {
	if o != nil && !IsNil(o.ConnectedEndpointsReachable) {
		return true
	}
