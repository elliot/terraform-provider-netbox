...
func (o *PatchedL2VPNTerminationRequest) GetL2vpn() int32 {
...
func (o *PatchedL2VPNTerminationRequest) GetL2vpnOk() (*int32, bool) {
	if o == nil || IsNil(o.L2vpn) {
		return nil, false
	}
	return o.L2vpn, true
...
func (o *PatchedL2VPNTerminationRequest) SetL2vpn(v int32) {
	o.L2vpn = &v
}
