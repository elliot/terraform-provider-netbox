...
func (o *PatchedBulkCustomLinkRequest) GetButtonClass() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkCustomLinkRequest) GetButtonClassOk() (*string, bool) {
	if o == nil || IsNil(o.ButtonClass) {
		return nil, false
	}
...
func (o *PatchedBulkCustomLinkRequest) SetButtonClass(v string) {
	o.ButtonClass = &v
}
...
func (o *PatchedBulkCustomLinkRequest) GetOwner() int32 {
...
func (o *PatchedBulkCustomLinkRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkCustomLinkRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
