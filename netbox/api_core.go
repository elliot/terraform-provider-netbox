...
type ApiCoreJobsListRequest struct {
	...
	executionTimeGte    *string
	executionTimeLte    *string
	fields              *string
	id                  *[]int32
	idEmpty             *bool
	idGt                *[]int32
...
// Execution time
func (r ApiCoreJobsListRequest) ExecutionTime(executionTime string) ApiCoreJobsListRequest {
	r.executionTime = &executionTime
	return r
}

// Execution time (minimum)
func (r ApiCoreJobsListRequest) ExecutionTimeGte(executionTimeGte string) ApiCoreJobsListRequest {
	r.executionTimeGte = &executionTimeGte
	return r
}

// Execution time (maximum)
func (r ApiCoreJobsListRequest) ExecutionTimeLte(executionTimeLte string) ApiCoreJobsListRequest {
	r.executionTimeLte = &executionTimeLte
	return r
}
...
func (a *CoreAPIService) CoreJobsListExecute(r ApiCoreJobsListRequest) (*PaginatedJobList, *http.Response, error) {
	...
	if r.executionTime != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "execution_time", r.executionTime, "form", "")
	}
	if r.executionTimeGte != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "execution_time__gte", r.executionTimeGte, "form", "")
	}
	if r.executionTimeLte != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "execution_time__lte", r.executionTimeLte, "form", "")
	}
	if r.fields != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "fields", r.fields, "form", "")
	}
...
// * &#x60;create&#x60; - Created * &#x60;update&#x60; - Updated * &#x60;delete&#x60; - Deleted
func (r ApiCoreObjectChangesListRequest) ActionN(actionN string) ApiCoreObjectChangesListRequest {
	r.actionN = &actionN
	return r
}
