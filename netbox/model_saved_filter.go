...
func NewSavedFilter(id int32) *SavedFilter {
	this := SavedFilter{}
	this.Id = id
	return &this
}
...
func (o *SavedFilter) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *SavedFilter) HasObjectTypes() bool {
	if o != nil && !IsNil(o.ObjectTypes) {
		return true
	}
...
func (o *SavedFilter) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *SavedFilter) HasSlug() bool {
	if o != nil && !IsNil(o.Slug) {
		return true
	}
...
func (o *SavedFilter) HasParameters() bool {
	if o != nil && !IsNil(o.Parameters) {
		return true
	}
