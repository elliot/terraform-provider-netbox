...
func NewBriefIPAddress(id int32) *BriefIPAddress {
	this := BriefIPAddress{}
	this.Id = id
	return &this
}
...
func (o *BriefIPAddress) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *BriefIPAddress) GetFamily() ChoiceInteger {
...
// and a boolean to check if the value has been set.
func (o *BriefIPAddress) GetFamilyOk() (*ChoiceInteger, bool) {
	if o == nil || IsNil(o.Family) {
		return nil, false
	}
...
func (o *BriefIPAddress) HasFamily() bool {
	if o != nil && !IsNil(o.Family) {
		return true
	}
...
func (o *BriefIPAddress) SetFamily(v ChoiceInteger) {
	o.Family = &v
}
...
func (o *BriefIPAddress) HasAddress() bool {
	if o != nil && !IsNil(o.Address) {
		return true
	}
...
func (o *BriefIPAddress) HasNatOutside() bool {
	if o != nil && !IsNil(o.NatOutside) {
		return true
	}
...
func (o *BriefIPAddress) GetDnsName() string {
...
// and a boolean to check if the value has been set.
func (o *BriefIPAddress) GetDnsNameOk() (*string, bool) {
	if o == nil || IsNil(o.DnsName) {
		return nil, false
	}
...
func (o *BriefIPAddress) SetDnsName(v string) {
	o.DnsName = &v
}
