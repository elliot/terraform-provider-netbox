...
type CableBundle struct {
	...
	CableCount           *int32                 `json:"cable_count,omitempty"`
...
func NewCableBundle(id int32) *CableBundle {
	this := CableBundle{}
	this.Id = id
	return &this
}
...
func (o *CableBundle) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *CableBundle) HasDisplay() bool {
	if o != nil && !IsNil(o.Display) {
		return true
	}
...
func (o *CableBundle) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
// GetCableCount returns the CableCount field value if set, zero value otherwise.
func (o *CableBundle) GetCableCount() int32 {
	if o == nil || IsNil(o.CableCount) {
		var ret int32
		return ret
	}
	return *o.CableCount
...
// GetCableCountOk returns a tuple with the CableCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasCableCount returns a boolean if a field has been set.
func (o *CableBundle) HasCableCount() bool {
	if o != nil && !IsNil(o.CableCount) {
		return true
	}
...
// SetCableCount gets a reference to the given int32 and assigns it to the CableCount field.
