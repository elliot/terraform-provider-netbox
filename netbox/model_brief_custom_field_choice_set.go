...
func NewBriefCustomFieldChoiceSet(id int32) *BriefCustomFieldChoiceSet {
...
func (o *BriefCustomFieldChoiceSet) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *BriefCustomFieldChoiceSet) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
