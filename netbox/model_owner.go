...
type Owner struct {
	...
	UserGroups           []BriefGroup            `json:"user_groups,omitempty"`
...
func (o *Owner) GetUserGroups() []BriefGroup {
...
// and a boolean to check if the value has been set.
func (o *Owner) GetUserGroupsOk() ([]BriefGroup, bool) {
	if o == nil || IsNil(o.UserGroups) {
		return nil, false
	}
...
// SetUserGroups gets a reference to the given []BriefGroup and assigns it to the UserGroups field.
func (o *Owner) SetUserGroups(v []BriefGroup) {
	o.UserGroups = v
}

// GetUsers returns the Users field value if set, zero value otherwise.
func (o *Owner) GetUsers() []BriefUser {
...
// and a boolean to check if the value has been set.
func (o *Owner) GetUsersOk() ([]BriefUser, bool) {
	if o == nil || IsNil(o.Users) {
		return nil, false
	}
	return o.Users, true
...
func (o *Owner) SetUsers(v []BriefUser) {
	o.Users = v
}
