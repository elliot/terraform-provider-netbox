...
func NewVirtualCircuitType(id int32) *VirtualCircuitType {
...
func (o *VirtualCircuitType) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *VirtualCircuitType) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *VirtualCircuitType) HasSlug() bool {
	if o != nil && !IsNil(o.Slug) {
		return true
	}
...
// GetVirtualCircuitCount returns the VirtualCircuitCount field value if set, zero value otherwise.
func (o *VirtualCircuitType) GetVirtualCircuitCount() int64 {
	if o == nil || IsNil(o.VirtualCircuitCount) {
		var ret int64
		return ret
	}
...
// GetVirtualCircuitCountOk returns a tuple with the VirtualCircuitCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetVirtualCircuitCount gets a reference to the given int64 and assigns it to the VirtualCircuitCount field.
...
func (o VirtualCircuitType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.VirtualCircuitCount) {
