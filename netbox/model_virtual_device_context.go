...
func NewVirtualDeviceContext(id int32) *VirtualDeviceContext {
...
func (o *VirtualDeviceContext) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *VirtualDeviceContext) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *VirtualDeviceContext) HasDevice() bool {
	if o != nil && !IsNil(o.Device) {
		return true
	}
...
func (o *VirtualDeviceContext) GetStatus() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *VirtualDeviceContext) GetStatusOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *VirtualDeviceContext) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *VirtualDeviceContext) SetStatus(v ChoiceString) {
	o.Status = &v
}
