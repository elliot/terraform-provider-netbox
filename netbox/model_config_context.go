...
type ConfigContext struct {
	...
	Regions       []BriefRegion                     `json:"regions,omitempty"`
	SiteGroups    []BriefSiteGroup                  `json:"site_groups,omitempty"`
	Sites         []BriefSite                       `json:"sites,omitempty"`
	Locations     []BriefLocation                   `json:"locations,omitempty"`
	DeviceTypes   []BriefDeviceType                 `json:"device_types,omitempty"`
	Roles         []BriefDeviceRole                 `json:"roles,omitempty"`
	Platforms     []BriefPlatform                   `json:"platforms,omitempty"`
	ClusterTypes  []BriefClusterType                `json:"cluster_types,omitempty"`
	ClusterGroups []BriefClusterGroup               `json:"cluster_groups,omitempty"`
	Clusters      []BriefCluster                    `json:"clusters,omitempty"`
	TenantGroups  []BriefTenantGroup                `json:"tenant_groups,omitempty"`
	Tenants       []BriefTenant                     `json:"tenants,omitempty"`
...
func NewConfigContext(id int32) *ConfigContext {
	this := ConfigContext{}
	this.Id = id
	return &this
}
...
func (o *ConfigContext) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
// SetRegions gets a reference to the given []BriefRegion and assigns it to the Regions field.
...
// SetSiteGroups gets a reference to the given []BriefSiteGroup and assigns it to the SiteGroups field.
...
// SetSites gets a reference to the given []BriefSite and assigns it to the Sites field.
...
// SetLocations gets a reference to the given []BriefLocation and assigns it to the Locations field.
...
// SetDeviceTypes gets a reference to the given []BriefDeviceType and assigns it to the DeviceTypes field.
...
// SetRoles gets a reference to the given []BriefDeviceRole and assigns it to the Roles field.
...
// SetPlatforms gets a reference to the given []BriefPlatform and assigns it to the Platforms field.
...
// SetClusterTypes gets a reference to the given []BriefClusterType and assigns it to the ClusterTypes field.
...
// SetClusterGroups gets a reference to the given []BriefClusterGroup and assigns it to the ClusterGroups field.
...
// SetClusters gets a reference to the given []BriefCluster and assigns it to the Clusters field.
...
// SetTenantGroups gets a reference to the given []BriefTenantGroup and assigns it to the TenantGroups field.
...
// SetTenants gets a reference to the given []BriefTenant and assigns it to the Tenants field.
...
func (o *ConfigContext) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
