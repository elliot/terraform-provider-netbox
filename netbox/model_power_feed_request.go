...
func NewPowerFeedRequest(powerPanel int32, name string) *PowerFeedRequest {
...
func (o *PowerFeedRequest) GetPowerPanel() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o *PowerFeedRequest) GetPowerPanelOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PowerFeedRequest) GetRackOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PowerFeedRequest) SetRack(v int32) {
	o.Rack.Set(&v)
}
...
func (o *PowerFeedRequest) GetTenant() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PowerFeedRequest) GetTenantOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PowerFeedRequest) SetTenant(v int32) {
	o.Tenant.Set(&v)
}
...
func (o *PowerFeedRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PowerFeedRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PowerFeedRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
