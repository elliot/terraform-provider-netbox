...
type Module struct {
	...
	IsBayCompatible      *bool                  `json:"is_bay_compatible,omitempty"`
...
func NewModule(id int32) *Module {
	this := Module{}
	this.Id = id
	return &this
}
...
func (o *Module) HasModuleBay() bool {
	if o != nil && !IsNil(o.ModuleBay) {
		return true
	}
...
// SetModuleType gets a reference to the given BriefModuleType and assigns it to the ModuleType field.
func (o *Module) SetModuleType(v BriefModuleType) {
	o.ModuleType = &v
}

// GetStatus returns the Status field value if set, zero value otherwise.
func (o *Module) GetStatus() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *Module) GetStatusOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *Module) SetStatus(v ChoiceString) {
	o.Status = &v
}
...
// GetIsBayCompatible returns the IsBayCompatible field value if set, zero value otherwise.
func (o *Module) GetIsBayCompatible() bool {
	if o == nil || IsNil(o.IsBayCompatible) {
		var ret bool
		return ret
	}
	return *o.IsBayCompatible
}

// GetIsBayCompatibleOk returns a tuple with the IsBayCompatible field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Module) GetIsBayCompatibleOk() (*bool, bool) {
	if o == nil || IsNil(o.IsBayCompatible) {
		return nil, false
	}
	return o.IsBayCompatible, true
}

// HasIsBayCompatible returns a boolean if a field has been set.
func (o *Module) HasIsBayCompatible() bool {
	if o != nil && !IsNil(o.IsBayCompatible) {
		return true
	}
...
// SetIsBayCompatible gets a reference to the given bool and assigns it to the IsBayCompatible field.
func (o *Module) SetIsBayCompatible(v bool) {
	o.IsBayCompatible = &v
}
...
func (o Module) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsBayCompatible) {
		toSerialize["is_bay_compatible"] = o.IsBayCompatible
	}
...
func (o *Module) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Module(varModule)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "is_bay_compatible")
