...
func NewManufacturer(id int32) *Manufacturer {
	this := Manufacturer{}
	this.Id = id
	return &this
}
...
func (o *Manufacturer) HasModuletypeCount() bool {
	if o != nil && !IsNil(o.ModuletypeCount) {
		return true
	}
...
// SetModuletypeCount gets a reference to the given int64 and assigns it to the ModuletypeCount field.
