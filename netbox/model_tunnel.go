...
type Tunnel struct {
	...
	Encapsulation        *ChoiceString             `json:"encapsulation,omitempty"`
...
func NewTunnel(id int32) *Tunnel {
	this := Tunnel{}
	this.Id = id
	return &this
}
...
func (o *Tunnel) GetStatus() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *Tunnel) GetStatusOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *Tunnel) SetStatus(v ChoiceString) {
	o.Status = &v
}
...
func (o *Tunnel) GetEncapsulation() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *Tunnel) GetEncapsulationOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Encapsulation) {
		return nil, false
	}
...
func (o *Tunnel) HasEncapsulation() bool {
	if o != nil && !IsNil(o.Encapsulation) {
		return true
	}
...
// SetEncapsulation gets a reference to the given ChoiceString and assigns it to the Encapsulation field.
func (o *Tunnel) SetEncapsulation(v ChoiceString) {
	o.Encapsulation = &v
}
