...
func (o *PatchedWritableVLANRequest) GetQinqRole() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedWritableVLANRequest) GetQinqRoleOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableVLANRequest) SetQinqRole(v string) {
	o.QinqRole.Set(&v)
}
...
func (o *PatchedWritableVLANRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedWritableVLANRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableVLANRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
