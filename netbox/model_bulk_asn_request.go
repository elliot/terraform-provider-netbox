...
func (o *BulkASNRequest) GetRir() int32 {
...
func (o *BulkASNRequest) GetRirOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkASNRequest) SetRir(v int32) {
	o.Rir.Set(&v)
}
...
func (o *BulkASNRequest) GetRole() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkASNRequest) GetRoleOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkASNRequest) SetRole(v int32) {
	o.Role.Set(&v)
}
...
func (o *BulkASNRequest) GetTenant() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkASNRequest) GetTenantOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkASNRequest) SetTenant(v int32) {
	o.Tenant.Set(&v)
}
...
func (o *BulkASNRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkASNRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkASNRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
