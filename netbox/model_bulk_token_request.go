...
func NewBulkTokenRequest(id int32, user int32) *BulkTokenRequest {
...
func (o *BulkTokenRequest) GetVersion() int32 {
...
// and a boolean to check if the value has been set.
func (o *BulkTokenRequest) GetVersionOk() (*int32, bool) {
	if o == nil || IsNil(o.Version) {
		return nil, false
	}
...
func (o *BulkTokenRequest) SetVersion(v int32) {
	o.Version = &v
}

// GetUser returns the User field value
func (o *BulkTokenRequest) GetUser() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BulkTokenRequest) GetUserOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.User, true
...
func (o *BulkTokenRequest) SetUser(v int32) {
	o.User = v
}
