...
func (o *PatchedTunnelGroupRequest) GetOwner() int32 {
...
func (o *PatchedTunnelGroupRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedTunnelGroupRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
