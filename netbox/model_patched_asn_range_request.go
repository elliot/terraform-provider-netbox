...
func (o *PatchedASNRangeRequest) GetRir() int32 {
...
// and a boolean to check if the value has been set.
func (o *PatchedASNRangeRequest) GetRirOk() (*int32, bool) {
	if o == nil || IsNil(o.Rir) {
		return nil, false
	}
	return o.Rir, true
...
func (o *PatchedASNRangeRequest) SetRir(v int32) {
	o.Rir = &v
}
...
func (o *PatchedASNRangeRequest) GetTenant() int32 {
...
func (o *PatchedASNRangeRequest) GetTenantOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedASNRangeRequest) SetTenant(v int32) {
	o.Tenant.Set(&v)
}
...
func (o *PatchedASNRangeRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedASNRangeRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedASNRangeRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
