...
func NewProviderAccount(id int32) *ProviderAccount {
...
func (o *ProviderAccount) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *ProviderAccount) HasProvider() bool {
	if o != nil && !IsNil(o.Provider) {
		return true
	}
...
func (o *ProviderAccount) HasAccount() bool {
	if o != nil && !IsNil(o.Account) {
		return true
	}
