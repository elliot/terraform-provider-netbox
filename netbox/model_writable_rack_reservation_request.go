...
func (o *WritableRackReservationRequest) GetStatus() string {
...
// and a boolean to check if the value has been set.
func (o *WritableRackReservationRequest) GetStatusOk() (*string, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *WritableRackReservationRequest) SetStatus(v string) {
	o.Status = &v
}
...
func (o *WritableRackReservationRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WritableRackReservationRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableRackReservationRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
