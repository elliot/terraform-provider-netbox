...
func (o *PatchedBulkRackRoleRequest) GetOwner() int32 {
...
func (o *PatchedBulkRackRoleRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkRackRoleRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
