...
type PaginatedTableConfigList struct {
	...
	Results              []TableConfig  `json:"results,omitempty"`
...
func NewPaginatedTableConfigList() *PaginatedTableConfigList {
...
func (o *PaginatedTableConfigList) HasCount() bool {
	if o != nil && !IsNil(o.Count) {
		return true
	}
...
func (o *PaginatedTableConfigList) HasResults() bool {
	if o != nil && !IsNil(o.Results) {
		return true
	}
...
// SetResults gets a reference to the given []TableConfig and assigns it to the Results field.
