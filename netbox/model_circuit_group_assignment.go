...
func NewCircuitGroupAssignment(id int32) *CircuitGroupAssignment {
...
func (o *CircuitGroupAssignment) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *CircuitGroupAssignment) HasGroup() bool {
	if o != nil && !IsNil(o.Group) {
		return true
	}
...
func (o *CircuitGroupAssignment) HasMemberType() bool {
	if o != nil && !IsNil(o.MemberType) {
		return true
	}
...
func (o *CircuitGroupAssignment) HasMemberId() bool {
	if o != nil && !IsNil(o.MemberId) {
		return true
	}
...
func (o *CircuitGroupAssignment) GetPriority() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *CircuitGroupAssignment) GetPriorityOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Priority) {
		return nil, false
	}
...
func (o *CircuitGroupAssignment) SetPriority(v ChoiceString) {
	o.Priority = &v
}
