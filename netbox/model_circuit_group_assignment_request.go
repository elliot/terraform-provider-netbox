...
func NewCircuitGroupAssignmentRequest(group int32, memberType string, memberId int64) *CircuitGroupAssignmentRequest {
...
func (o *CircuitGroupAssignmentRequest) GetGroup() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o *CircuitGroupAssignmentRequest) GetGroupOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Group, true
...
func (o *CircuitGroupAssignmentRequest) SetGroup(v int32) {
	o.Group = v
}
