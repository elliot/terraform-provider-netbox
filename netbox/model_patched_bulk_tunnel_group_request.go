...
func (o *PatchedBulkTunnelGroupRequest) GetOwner() int32 {
...
func (o *PatchedBulkTunnelGroupRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkTunnelGroupRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
