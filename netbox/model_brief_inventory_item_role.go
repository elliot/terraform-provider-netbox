...
func NewBriefInventoryItemRole(id int32) *BriefInventoryItemRole {
...
func (o *BriefInventoryItemRole) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *BriefInventoryItemRole) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *BriefInventoryItemRole) HasSlug() bool {
	if o != nil && !IsNil(o.Slug) {
		return true
	}
