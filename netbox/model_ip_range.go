...
func NewIPRange(id int32) *IPRange {
	this := IPRange{}
	this.Id = id
	return &this
}
...
func (o *IPRange) GetFamily() ChoiceInteger {
...
// and a boolean to check if the value has been set.
func (o *IPRange) GetFamilyOk() (*ChoiceInteger, bool) {
	if o == nil || IsNil(o.Family) {
		return nil, false
	}
...
func (o *IPRange) SetFamily(v ChoiceInteger) {
	o.Family = &v
}
...
func (o *IPRange) HasStartAddress() bool {
	if o != nil && !IsNil(o.StartAddress) {
		return true
	}
...
func (o *IPRange) HasEndAddress() bool {
	if o != nil && !IsNil(o.EndAddress) {
		return true
	}
...
func (o *IPRange) GetStatus() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *IPRange) GetStatusOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *IPRange) SetStatus(v ChoiceString) {
	o.Status = &v
}
