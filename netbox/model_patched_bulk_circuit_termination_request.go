...
func (o *PatchedBulkCircuitTerminationRequest) GetCircuit() int32 {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkCircuitTerminationRequest) GetCircuitOk() (*int32, bool) {
	if o == nil || IsNil(o.Circuit) {
		return nil, false
	}
...
func (o *PatchedBulkCircuitTerminationRequest) SetCircuit(v int32) {
	o.Circuit = &v
}

// GetTermSide returns the TermSide field value if set, zero value otherwise.
func (o *PatchedBulkCircuitTerminationRequest) GetTermSide() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkCircuitTerminationRequest) GetTermSideOk() (*string, bool) {
	if o == nil || IsNil(o.TermSide) {
		return nil, false
	}
...
func (o *PatchedBulkCircuitTerminationRequest) SetTermSide(v string) {
	o.TermSide = &v
}
