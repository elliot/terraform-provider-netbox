...
func NewPaginatedDeviceList() *PaginatedDeviceList {
...
func (o *PaginatedDeviceList) HasResults() bool {
	if o != nil && !IsNil(o.Results) {
		return true
	}
...
// SetResults gets a reference to the given []Device and assigns it to the Results field.
