...
func (o *WebhookRequest) SetTimeoutNil() {
	o.Timeout.Set(nil)
}
...
func (o *WebhookRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebhookRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebhookRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
