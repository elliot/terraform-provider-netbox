...
type FHRPGroup struct {
	...
	IpAddresses          []BriefIPAddress       `json:"ip_addresses,omitempty"`
...
func NewFHRPGroup(id int32) *FHRPGroup {
	this := FHRPGroup{}
	this.Id = id
	return &this
}
...
func (o *FHRPGroup) HasProtocol() bool {
	if o != nil && !IsNil(o.Protocol) {
		return true
	}
...
func (o *FHRPGroup) HasGroupId() bool {
	if o != nil && !IsNil(o.GroupId) {
		return true
	}
...
func (o *FHRPGroup) HasIpAddresses() bool {
	if o != nil && !IsNil(o.IpAddresses) {
		return true
	}
