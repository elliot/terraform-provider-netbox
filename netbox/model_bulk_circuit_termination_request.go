...
func NewBulkCircuitTerminationRequest(id int32, circuit int32, termSide string) *BulkCircuitTerminationRequest {
...
func (o *BulkCircuitTerminationRequest) GetCircuit() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BulkCircuitTerminationRequest) GetCircuitOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkCircuitTerminationRequest) SetCircuit(v int32) {
	o.Circuit = v
}

// GetTermSide returns the TermSide field value
func (o *BulkCircuitTerminationRequest) GetTermSide() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BulkCircuitTerminationRequest) GetTermSideOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkCircuitTerminationRequest) SetTermSide(v string) {
	o.TermSide = v
}
