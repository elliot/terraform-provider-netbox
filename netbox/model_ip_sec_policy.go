...
type IPSecPolicy struct {
	...
	Proposals            []BriefIPSecProposal   `json:"proposals,omitempty"`
	PfsGroup             *ChoiceInteger         `json:"pfs_group,omitempty"`
...
func NewIPSecPolicy(id int32) *IPSecPolicy {
	this := IPSecPolicy{}
	this.Id = id
	return &this
}
...
func (o *IPSecPolicy) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *IPSecPolicy) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
// SetProposals gets a reference to the given []BriefIPSecProposal and assigns it to the Proposals field.
...
func (o *IPSecPolicy) GetPfsGroup() ChoiceInteger {
...
// and a boolean to check if the value has been set.
func (o *IPSecPolicy) GetPfsGroupOk() (*ChoiceInteger, bool) {
	if o == nil || IsNil(o.PfsGroup) {
		return nil, false
	}
...
// SetPfsGroup gets a reference to the given ChoiceInteger and assigns it to the PfsGroup field.
func (o *IPSecPolicy) SetPfsGroup(v ChoiceInteger) {
	o.PfsGroup = &v
}
