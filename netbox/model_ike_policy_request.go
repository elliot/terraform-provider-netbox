...
func NewIKEPolicyRequest(name string) *IKEPolicyRequest {
...
func (o *IKEPolicyRequest) HasVersion() bool {
	if o != nil && !IsNil(o.Version) {
		return true
	}
...
func (o *IKEPolicyRequest) GetOwner() int32 {
...
func (o *IKEPolicyRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *IKEPolicyRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
