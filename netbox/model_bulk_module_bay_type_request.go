...
func (o *BulkModuleBayTypeRequest) GetManufacturer() int32 {
...
func (o *BulkModuleBayTypeRequest) GetManufacturerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkModuleBayTypeRequest) SetManufacturer(v int32) {
...
func (o *BulkModuleBayTypeRequest) GetColor() string {
...
// and a boolean to check if the value has been set.
func (o *BulkModuleBayTypeRequest) GetColorOk() (*string, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *BulkModuleBayTypeRequest) SetColor(v string) {
	o.Color = &v
}
...
func (o *BulkModuleBayTypeRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkModuleBayTypeRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkModuleBayTypeRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
