...
func NewRearPort(id int32) *RearPort {
	this := RearPort{}
	this.Id = id
	return &this
}
...
func (o *RearPort) GetType() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *RearPort) GetTypeOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *RearPort) SetType(v ChoiceString) {
	o.Type = &v
}
...
func (o *RearPort) HasLinkPeers() bool {
	if o != nil && !IsNil(o.LinkPeers) {
		return true
	}
