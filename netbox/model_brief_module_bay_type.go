...
// checks if the BriefModuleBayType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BriefModuleBayType{}

// BriefModuleBayType Base serializer class for models inheriting from PrimaryModel.
type BriefModuleBayType struct {
	Id                   int32                     `json:"id"`
...
type _BriefModuleBayType BriefModuleBayType

// NewBriefModuleBayType instantiates a new BriefModuleBayType object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewBriefModuleBayType(id int32) *BriefModuleBayType {
	this := BriefModuleBayType{}
	this.Id = id
	return &this
}
...
func (o *BriefModuleBayType) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *BriefModuleBayType) HasDisplay() bool {
	if o != nil && !IsNil(o.Display) {
		return true
	}
...
func (o *BriefModuleBayType) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *BriefModuleBayType) HasSlug() bool {
	if o != nil && !IsNil(o.Slug) {
		return true
	}
...
func (o *BriefModuleBayType) SetManufacturerNil() {
...
func (o *BriefModuleBayType) GetColor() string {
...
// and a boolean to check if the value has been set.
func (o *BriefModuleBayType) GetColorOk() (*string, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *BriefModuleBayType) SetColor(v string) {
	o.Color = &v
}
...
func (o BriefModuleBayType) MarshalJSON() ([]byte, error) {
...
func (o BriefModuleBayType) ToMap() (map[string]interface{}, error) {
...
func (o *BriefModuleBayType) UnmarshalJSON(data []byte) (err error) {
	...
	varBriefModuleBayType := _BriefModuleBayType{}

	err = json.Unmarshal(data, &varBriefModuleBayType)

	if err != nil {
		return err
	}

	*o = BriefModuleBayType(varBriefModuleBayType)
...
type NullableBriefModuleBayType struct {
	value *BriefModuleBayType
	isSet bool
}

func (v NullableBriefModuleBayType) Get() *BriefModuleBayType {
	return v.value
}

func (v *NullableBriefModuleBayType) Set(val *BriefModuleBayType) {
	v.value = val
	v.isSet = true
}

func (v NullableBriefModuleBayType) IsSet() bool {
	return v.isSet
}

func (v *NullableBriefModuleBayType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBriefModuleBayType(val *BriefModuleBayType) *NullableBriefModuleBayType {
	return &NullableBriefModuleBayType{value: val, isSet: true}
}

func (v NullableBriefModuleBayType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBriefModuleBayType) UnmarshalJSON(src []byte) error {
	v.isSet = true
