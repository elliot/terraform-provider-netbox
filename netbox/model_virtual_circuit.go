...
type VirtualCircuit struct {
	...
	ProviderNetwork      *BriefProviderNetwork        `json:"provider_network,omitempty"`
	ProviderAccount      NullableBriefProviderAccount `json:"provider_account,omitempty"`
	Type                 *BriefVirtualCircuitType     `json:"type,omitempty"`
...
func NewVirtualCircuit(id int32) *VirtualCircuit {
	this := VirtualCircuit{}
	this.Id = id
	return &this
}
...
func (o *VirtualCircuit) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *VirtualCircuit) HasCid() bool {
	if o != nil && !IsNil(o.Cid) {
		return true
	}
...
func (o *VirtualCircuit) HasProviderNetwork() bool {
	if o != nil && !IsNil(o.ProviderNetwork) {
		return true
	}
...
// SetProviderNetwork gets a reference to the given BriefProviderNetwork and assigns it to the ProviderNetwork field.
...
// SetType gets a reference to the given BriefVirtualCircuitType and assigns it to the Type field.
func (o *VirtualCircuit) SetType(v BriefVirtualCircuitType) {
	o.Type = &v
}

// GetStatus returns the Status field value if set, zero value otherwise.
func (o *VirtualCircuit) GetStatus() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *VirtualCircuit) GetStatusOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *VirtualCircuit) SetStatus(v ChoiceString) {
	o.Status = &v
}
