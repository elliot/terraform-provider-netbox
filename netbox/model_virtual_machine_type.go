...
func NewVirtualMachineType(id int32) *VirtualMachineType {
...
func (o *VirtualMachineType) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *VirtualMachineType) HasDisplay() bool {
	if o != nil && !IsNil(o.Display) {
		return true
	}
...
func (o *VirtualMachineType) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *VirtualMachineType) HasSlug() bool {
	if o != nil && !IsNil(o.Slug) {
		return true
	}
...
func (o *VirtualMachineType) HasVirtualMachineCount() bool {
	if o != nil && !IsNil(o.VirtualMachineCount) {
		return true
	}
