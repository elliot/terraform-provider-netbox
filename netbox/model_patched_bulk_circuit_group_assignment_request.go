...
func (o *PatchedBulkCircuitGroupAssignmentRequest) GetGroup() int32 {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkCircuitGroupAssignmentRequest) GetGroupOk() (*int32, bool) {
	if o == nil || IsNil(o.Group) {
		return nil, false
	}
	return o.Group, true
...
func (o *PatchedBulkCircuitGroupAssignmentRequest) SetGroup(v int32) {
	o.Group = &v
}
...
func (o *PatchedBulkCircuitGroupAssignmentRequest) GetPriority() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkCircuitGroupAssignmentRequest) GetPriorityOk() (*string, bool) {
	if o == nil || IsNil(o.Priority) {
		return nil, false
	}
...
func (o *PatchedBulkCircuitGroupAssignmentRequest) SetPriority(v string) {
	o.Priority = &v
}
