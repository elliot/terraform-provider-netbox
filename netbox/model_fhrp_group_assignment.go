...
type FHRPGroupAssignment struct {
	...
	Group                *BriefFHRPGroup `json:"group,omitempty"`
...
func NewFHRPGroupAssignment(id int32) *FHRPGroupAssignment {
...
func (o *FHRPGroupAssignment) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *FHRPGroupAssignment) HasGroup() bool {
	if o != nil && !IsNil(o.Group) {
		return true
	}
...
// SetGroup gets a reference to the given BriefFHRPGroup and assigns it to the Group field.
...
func (o *FHRPGroupAssignment) HasInterfaceType() bool {
	if o != nil && !IsNil(o.InterfaceType) {
		return true
	}
...
func (o *FHRPGroupAssignment) HasInterfaceId() bool {
	if o != nil && !IsNil(o.InterfaceId) {
		return true
	}
...
func (o *FHRPGroupAssignment) HasPriority() bool {
	if o != nil && !IsNil(o.Priority) {
		return true
	}
