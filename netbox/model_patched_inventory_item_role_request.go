...
func (o *PatchedInventoryItemRoleRequest) GetOwner() int32 {
...
func (o *PatchedInventoryItemRoleRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedInventoryItemRoleRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
