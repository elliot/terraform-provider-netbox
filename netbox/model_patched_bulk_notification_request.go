...
func (o *PatchedBulkNotificationRequest) GetUser() int32 {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkNotificationRequest) GetUserOk() (*int32, bool) {
	if o == nil || IsNil(o.User) {
		return nil, false
	}
	return o.User, true
...
func (o *PatchedBulkNotificationRequest) SetUser(v int32) {
	o.User = &v
}
...
func (o *PatchedBulkNotificationRequest) GetEventType() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkNotificationRequest) GetEventTypeOk() (*string, bool) {
	if o == nil || IsNil(o.EventType) {
		return nil, false
	}
...
func (o *PatchedBulkNotificationRequest) SetEventType(v string) {
	o.EventType = &v
}
