...
func (o *PatchedWritableCircuitRequest) GetDistanceUnit() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedWritableCircuitRequest) GetDistanceUnitOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableCircuitRequest) SetDistanceUnit(v string) {
...
func (o *PatchedWritableCircuitRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedWritableCircuitRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableCircuitRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
