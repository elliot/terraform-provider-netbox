...
type PatchedWritableIPSecProposalRequest struct {
	...
	EncryptionAlgorithm NullableString `json:"encryption_algorithm,omitempty"`
...
// SetEncryptionAlgorithm gets a reference to the given NullableString and assigns it to the EncryptionAlgorithm field.
...
func (o *PatchedWritableIPSecProposalRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedWritableIPSecProposalRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableIPSecProposalRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
