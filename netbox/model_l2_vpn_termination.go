...
type L2VPNTermination struct {
	...
	L2vpn                *BriefL2VPN            `json:"l2vpn,omitempty"`
...
func NewL2VPNTermination(id int32) *L2VPNTermination {
...
func (o *L2VPNTermination) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *L2VPNTermination) HasL2vpn() bool {
	if o != nil && !IsNil(o.L2vpn) {
		return true
	}
...
// SetL2vpn gets a reference to the given BriefL2VPN and assigns it to the L2vpn field.
...
func (o *L2VPNTermination) HasAssignedObjectType() bool {
	if o != nil && !IsNil(o.AssignedObjectType) {
		return true
	}
...
func (o *L2VPNTermination) HasAssignedObjectId() bool {
	if o != nil && !IsNil(o.AssignedObjectId) {
		return true
	}
