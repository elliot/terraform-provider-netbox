...
func NewScriptInputRequest(data interface{}, commit bool) *ScriptInputRequest {
	...
	this.Data = data
	this.Commit = commit
	var notifications string = "always"
...
func (o *ScriptInputRequest) GetNotifications() string {
...
// and a boolean to check if the value has been set.
func (o *ScriptInputRequest) GetNotificationsOk() (*string, bool) {
	if o == nil || IsNil(o.Notifications) {
		return nil, false
	}
...
func (o *ScriptInputRequest) SetNotifications(v string) {
	o.Notifications = &v
}
