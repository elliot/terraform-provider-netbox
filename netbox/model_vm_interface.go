...
func NewVMInterface(id int32) *VMInterface {
	this := VMInterface{}
	this.Id = id
	return &this
}
...
func (o *VMInterface) HasVirtualMachine() bool {
	if o != nil && !IsNil(o.VirtualMachine) {
		return true
	}
...
// SetVirtualMachine gets a reference to the given BriefVirtualMachine and assigns it to the VirtualMachine field.
...
func (o *VMInterface) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *VMInterface) GetMode() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *VMInterface) GetModeOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Mode) {
		return nil, false
	}
	return o.Mode, true
...
func (o *VMInterface) SetMode(v ChoiceString) {
	o.Mode = &v
}
