...
func (o *PatchedBulkVirtualCircuitTypeRequest) GetColor() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkVirtualCircuitTypeRequest) GetColorOk() (*string, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *PatchedBulkVirtualCircuitTypeRequest) SetColor(v string) {
	o.Color = &v
}
...
func (o *PatchedBulkVirtualCircuitTypeRequest) GetOwner() int32 {
...
func (o *PatchedBulkVirtualCircuitTypeRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkVirtualCircuitTypeRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
