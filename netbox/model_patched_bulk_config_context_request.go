...
type PatchedBulkConfigContextRequest struct {
	...
	DataSource           *int32        `json:"data_source,omitempty"`
...
func (o *PatchedBulkConfigContextRequest) GetProfile() int32 {
...
func (o *PatchedBulkConfigContextRequest) GetProfileOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkConfigContextRequest) SetProfile(v int32) {
	o.Profile.Set(&v)
}
...
func (o *PatchedBulkConfigContextRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedBulkConfigContextRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkConfigContextRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
...
func (o *PatchedBulkConfigContextRequest) GetDataSource() int32 {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkConfigContextRequest) GetDataSourceOk() (*int32, bool) {
	if o == nil || IsNil(o.DataSource) {
		return nil, false
	}
...
// SetDataSource gets a reference to the given int32 and assigns it to the DataSource field.
func (o *PatchedBulkConfigContextRequest) SetDataSource(v int32) {
	o.DataSource = &v
}
