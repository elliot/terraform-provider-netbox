...
func (o *BulkPowerPortTemplateRequest) GetDeviceType() int32 {
...
func (o *BulkPowerPortTemplateRequest) GetDeviceTypeOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkPowerPortTemplateRequest) SetDeviceType(v int32) {
	o.DeviceType.Set(&v)
}
...
func (o *BulkPowerPortTemplateRequest) GetModuleType() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkPowerPortTemplateRequest) GetModuleTypeOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkPowerPortTemplateRequest) SetModuleType(v int32) {
	o.ModuleType.Set(&v)
}
...
func (o *BulkPowerPortTemplateRequest) GetType() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkPowerPortTemplateRequest) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkPowerPortTemplateRequest) SetType(v string) {
	o.Type.Set(&v)
}
