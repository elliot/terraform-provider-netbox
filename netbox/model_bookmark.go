...
func NewBookmark(id int32) *Bookmark {
	this := Bookmark{}
	this.Id = id
	return &this
}
...
func (o *Bookmark) HasObjectType() bool {
	if o != nil && !IsNil(o.ObjectType) {
		return true
	}
...
func (o *Bookmark) HasObjectId() bool {
	if o != nil && !IsNil(o.ObjectId) {
		return true
	}
