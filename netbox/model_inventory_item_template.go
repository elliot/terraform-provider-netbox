...
func NewInventoryItemTemplate(id int32) *InventoryItemTemplate {
...
func (o *InventoryItemTemplate) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *InventoryItemTemplate) HasDeviceType() bool {
	if o != nil && !IsNil(o.DeviceType) {
		return true
	}
...
func (o *InventoryItemTemplate) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
