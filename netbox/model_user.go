...
type User struct {
	...
	Permissions          []BriefObjectPermission `json:"permissions,omitempty"`
...
// SetPermissions gets a reference to the given []BriefObjectPermission and assigns it to the Permissions field.
