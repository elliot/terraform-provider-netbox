...
type PaginatedObjectTypeList struct {
	...
	Results              []ObjectType   `json:"results,omitempty"`
...
func NewPaginatedObjectTypeList() *PaginatedObjectTypeList {
...
func (o *PaginatedObjectTypeList) HasCount() bool {
	if o != nil && !IsNil(o.Count) {
		return true
	}
...
func (o *PaginatedObjectTypeList) HasResults() bool {
	if o != nil && !IsNil(o.Results) {
		return true
	}
...
// SetResults gets a reference to the given []ObjectType and assigns it to the Results field.
