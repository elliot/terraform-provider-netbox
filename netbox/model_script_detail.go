...
func NewScriptDetail(id int32) *ScriptDetail {
	this := ScriptDetail{}
	this.Id = id
	return &this
}
...
func (o *ScriptDetail) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *ScriptDetail) HasModule() bool {
	if o != nil && !IsNil(o.Module) {
		return true
	}
...
func (o *ScriptDetail) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ScriptDetail) HasResult() bool {
	if o != nil && !IsNil(o.Result) {
		return true
	}
...
// SetResult gets a reference to the given Job and assigns it to the Result field.
...
func (o *ScriptDetail) HasDisplay() bool {
	if o != nil && !IsNil(o.Display) {
		return true
	}
...
func (o *ScriptDetail) HasIsExecutable() bool {
	if o != nil && !IsNil(o.IsExecutable) {
		return true
	}
