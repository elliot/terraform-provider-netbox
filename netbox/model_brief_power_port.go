...
func NewBriefPowerPort(id int32) *BriefPowerPort {
	this := BriefPowerPort{}
	this.Id = id
	return &this
}
...
func (o *BriefPowerPort) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *BriefPowerPort) HasDevice() bool {
	if o != nil && !IsNil(o.Device) {
		return true
	}
...
func (o *BriefPowerPort) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *BriefPowerPort) HasOccupied() bool {
	if o != nil && !IsNil(o.Occupied) {
		return true
	}
