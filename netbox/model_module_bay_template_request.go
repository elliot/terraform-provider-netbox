...
func (o *ModuleBayTemplateRequest) GetDeviceType() int32 {
...
func (o *ModuleBayTemplateRequest) GetDeviceTypeOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ModuleBayTemplateRequest) SetDeviceType(v int32) {
	o.DeviceType.Set(&v)
}
...
func (o *ModuleBayTemplateRequest) GetModuleType() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ModuleBayTemplateRequest) GetModuleTypeOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ModuleBayTemplateRequest) SetModuleType(v int32) {
	o.ModuleType.Set(&v)
}
...
func (o *ModuleBayTemplateRequest) GetModuleBayTypes() []int32 {
...
// and a boolean to check if the value has been set.
func (o *ModuleBayTemplateRequest) GetModuleBayTypesOk() ([]int32, bool) {
	if o == nil || IsNil(o.ModuleBayTypes) {
		return nil, false
	}
...
func (o *ModuleBayTemplateRequest) HasModuleBayTypes() bool {
	if o != nil && !IsNil(o.ModuleBayTypes) {
		return true
	}
...
func (o *ModuleBayTemplateRequest) SetModuleBayTypes(v []int32) {
	o.ModuleBayTypes = v
}
