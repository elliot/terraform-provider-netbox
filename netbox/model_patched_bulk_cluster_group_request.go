...
func (o *PatchedBulkClusterGroupRequest) GetOwner() int32 {
...
func (o *PatchedBulkClusterGroupRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkClusterGroupRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
