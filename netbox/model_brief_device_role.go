...
func NewBriefDeviceRole(id int32) *BriefDeviceRole {
...
func (o *BriefDeviceRole) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *BriefDeviceRole) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *BriefDeviceRole) HasSlug() bool {
	if o != nil && !IsNil(o.Slug) {
		return true
	}
