...
func (o *PatchedWritableDeviceTypeRequest) GetCoolingMethod() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedWritableDeviceTypeRequest) GetCoolingMethodOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableDeviceTypeRequest) SetCoolingMethod(v string) {
	o.CoolingMethod.Set(&v)
}

// SetCoolingMethodNil sets the value for CoolingMethod to be an explicit nil
func (o *PatchedWritableDeviceTypeRequest) SetCoolingMethodNil() {
...
func (o *PatchedWritableDeviceTypeRequest) SetEndOfLifeNil() {
	o.EndOfLife.Set(nil)
}
...
func (o *PatchedWritableDeviceTypeRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedWritableDeviceTypeRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableDeviceTypeRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
