...
func NewLocation(id int32) *Location {
	this := Location{}
	this.Id = id
	return &this
}
...
func (o *Location) GetStatus() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *Location) GetStatusOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *Location) SetStatus(v ChoiceString) {
	o.Status = &v
}
