...
func (o *PatchedWritableDataSourceRequest) GetSyncInterval() int32 {
...
func (o *PatchedWritableDataSourceRequest) GetSyncIntervalOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableDataSourceRequest) SetSyncInterval(v int32) {
...
func (o *PatchedWritableDataSourceRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedWritableDataSourceRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableDataSourceRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
