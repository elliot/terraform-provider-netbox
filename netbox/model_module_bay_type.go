...
func NewModuleBayType(id int32) *ModuleBayType {
	this := ModuleBayType{}
	this.Id = id
	return &this
}
...
func (o *ModuleBayType) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *ModuleBayType) HasDisplay() bool {
	if o != nil && !IsNil(o.Display) {
		return true
	}
...
func (o *ModuleBayType) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ModuleBayType) HasSlug() bool {
	if o != nil && !IsNil(o.Slug) {
		return true
	}
...
func (o *ModuleBayType) GetColor() string {
...
// and a boolean to check if the value has been set.
func (o *ModuleBayType) GetColorOk() (*string, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *ModuleBayType) SetColor(v string) {
	o.Color = &v
}
