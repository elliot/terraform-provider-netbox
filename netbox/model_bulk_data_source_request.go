...
func NewBulkDataSourceRequest(id int32, name string, type_ string, sourceUrl string) *BulkDataSourceRequest {
...
func (o *BulkDataSourceRequest) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BulkDataSourceRequest) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *BulkDataSourceRequest) SetType(v string) {
	o.Type = v
}
...
func (o *BulkDataSourceRequest) GetSyncInterval() int32 {
...
func (o *BulkDataSourceRequest) GetSyncIntervalOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkDataSourceRequest) SetSyncInterval(v int32) {
...
func (o *BulkDataSourceRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkDataSourceRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkDataSourceRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
