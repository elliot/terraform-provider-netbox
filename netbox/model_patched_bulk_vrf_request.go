...
func (o *PatchedBulkVRFRequest) GetTenant() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedBulkVRFRequest) GetTenantOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkVRFRequest) SetTenant(v int32) {
	o.Tenant.Set(&v)
}
...
func (o *PatchedBulkVRFRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedBulkVRFRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkVRFRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
