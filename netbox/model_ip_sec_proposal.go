...
func NewIPSecProposal(id int32) *IPSecProposal {
	this := IPSecProposal{}
	this.Id = id
	return &this
}
...
func (o *IPSecProposal) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *IPSecProposal) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *IPSecProposal) GetEncryptionAlgorithm() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *IPSecProposal) GetEncryptionAlgorithmOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.EncryptionAlgorithm) {
		return nil, false
	}
...
func (o *IPSecProposal) SetEncryptionAlgorithm(v ChoiceString) {
...
func (o *IPSecProposal) GetAuthenticationAlgorithm() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *IPSecProposal) GetAuthenticationAlgorithmOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.AuthenticationAlgorithm) {
		return nil, false
	}
...
func (o *IPSecProposal) SetAuthenticationAlgorithm(v ChoiceString) {
