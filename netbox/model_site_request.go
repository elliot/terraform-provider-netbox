...
func (o *SiteRequest) GetRegion() int32 {
...
func (o *SiteRequest) GetRegionOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SiteRequest) SetRegion(v int32) {
	o.Region.Set(&v)
}
...
func (o *SiteRequest) GetGroup() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *SiteRequest) GetGroupOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SiteRequest) SetGroup(v int32) {
	o.Group.Set(&v)
}
...
func (o *SiteRequest) GetTenant() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *SiteRequest) GetTenantOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SiteRequest) SetTenant(v int32) {
	o.Tenant.Set(&v)
}
...
func (o *SiteRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *SiteRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SiteRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
