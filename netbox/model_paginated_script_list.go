...
func NewPaginatedScriptList() *PaginatedScriptList {
...
func (o *PaginatedScriptList) HasCount() bool {
	if o != nil && !IsNil(o.Count) {
		return true
	}
...
func (o *PaginatedScriptList) HasResults() bool {
	if o != nil && !IsNil(o.Results) {
		return true
	}
...
// SetResults gets a reference to the given []Script and assigns it to the Results field.
