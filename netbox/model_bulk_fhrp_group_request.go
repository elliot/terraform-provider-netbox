...
func NewBulkFHRPGroupRequest(id int32, protocol string, groupId int32) *BulkFHRPGroupRequest {
...
func (o *BulkFHRPGroupRequest) GetProtocol() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BulkFHRPGroupRequest) GetProtocolOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkFHRPGroupRequest) SetProtocol(v string) {
	o.Protocol = v
}
...
func (o *BulkFHRPGroupRequest) GetAuthType() string {
...
func (o *BulkFHRPGroupRequest) GetAuthTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkFHRPGroupRequest) SetAuthType(v string) {
	o.AuthType.Set(&v)
}
...
func (o *BulkFHRPGroupRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkFHRPGroupRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkFHRPGroupRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
