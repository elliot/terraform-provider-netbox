...
func (o *BulkWebhookRequest) GetHttpMethod() string {
...
// and a boolean to check if the value has been set.
func (o *BulkWebhookRequest) GetHttpMethodOk() (*string, bool) {
	if o == nil || IsNil(o.HttpMethod) {
		return nil, false
	}
...
func (o *BulkWebhookRequest) SetHttpMethod(v string) {
	o.HttpMethod = &v
}
...
func (o *BulkWebhookRequest) SetTimeoutNil() {
	o.Timeout.Set(nil)
}
...
func (o *BulkWebhookRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkWebhookRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkWebhookRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
