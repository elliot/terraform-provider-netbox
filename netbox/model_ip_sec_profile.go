...
type IPSecProfile struct {
	...
	IkePolicy            *BriefIKEPolicy        `json:"ike_policy,omitempty"`
	IpsecPolicy          *BriefIPSecPolicy      `json:"ipsec_policy,omitempty"`
...
func NewIPSecProfile(id int32) *IPSecProfile {
	this := IPSecProfile{}
	this.Id = id
	return &this
}
...
func (o *IPSecProfile) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *IPSecProfile) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *IPSecProfile) GetMode() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *IPSecProfile) GetModeOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Mode) {
		return nil, false
	}
	return o.Mode, true
...
func (o *IPSecProfile) HasMode() bool {
	if o != nil && !IsNil(o.Mode) {
		return true
	}
...
func (o *IPSecProfile) SetMode(v ChoiceString) {
	o.Mode = &v
}
...
func (o *IPSecProfile) HasIkePolicy() bool {
	if o != nil && !IsNil(o.IkePolicy) {
		return true
	}
...
// SetIkePolicy gets a reference to the given BriefIKEPolicy and assigns it to the IkePolicy field.
...
func (o *IPSecProfile) HasIpsecPolicy() bool {
	if o != nil && !IsNil(o.IpsecPolicy) {
		return true
	}
...
// SetIpsecPolicy gets a reference to the given BriefIPSecPolicy and assigns it to the IpsecPolicy field.
