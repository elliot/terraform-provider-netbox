...
func (o *PatchedBulkDataSourceRequest) GetType() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkDataSourceRequest) GetTypeOk() (*string, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *PatchedBulkDataSourceRequest) SetType(v string) {
	o.Type = &v
}
...
func (o *PatchedBulkDataSourceRequest) GetSyncInterval() int32 {
...
func (o *PatchedBulkDataSourceRequest) GetSyncIntervalOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkDataSourceRequest) SetSyncInterval(v int32) {
...
func (o *PatchedBulkDataSourceRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedBulkDataSourceRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkDataSourceRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
