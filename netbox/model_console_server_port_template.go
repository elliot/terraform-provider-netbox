...
func NewConsoleServerPortTemplate(id int32) *ConsoleServerPortTemplate {
...
func (o *ConsoleServerPortTemplate) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ConsoleServerPortTemplate) GetType() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *ConsoleServerPortTemplate) GetTypeOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *ConsoleServerPortTemplate) SetType(v ChoiceString) {
	o.Type = &v
}
