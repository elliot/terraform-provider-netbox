...
func (o *PatchedWritableRackReservationRequest) GetStatus() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedWritableRackReservationRequest) GetStatusOk() (*string, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *PatchedWritableRackReservationRequest) SetStatus(v string) {
	o.Status = &v
}
...
func (o *PatchedWritableRackReservationRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedWritableRackReservationRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableRackReservationRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
