...
type Interface struct {
	...
	Vdcs       []BriefVirtualDeviceContext `json:"vdcs,omitempty"`
	Module     NullableBriefModule         `json:"module,omitempty"`
	Name       *string                     `json:"name,omitempty"`
	// Physical label
	Label *string       `json:"label,omitempty"`
	Type  *ChoiceString `json:"type,omitempty"`
	...
	BridgeInterfaces  []NestedInterface       `json:"bridge_interfaces,omitempty"`
	...
	Duplex            NullableChoiceString    `json:"duplex,omitempty"`
	Wwn               NullableString          `json:"wwn,omitempty"`
	// This interface is used only for out-of-band management
	MgmtOnly    *bool         `json:"mgmt_only,omitempty"`
	Description *string       `json:"description,omitempty"`
	Mode        *ChoiceString `json:"mode,omitempty"`
	RfRole      *ChoiceString `json:"rf_role,omitempty"`
	RfChannel   *ChoiceString `json:"rf_channel,omitempty"`
	PoeMode     *ChoiceString `json:"poe_mode,omitempty"`
	PoeType     *ChoiceString `json:"poe_type,omitempty"`
	...
	TaggedVlans           []BriefVLAN                        `json:"tagged_vlans,omitempty"`
	...
	// * `A` - A * `B` - B
	CableEnd     NullableString             `json:"cable_end,omitempty"`
	...
	WirelessLans                []BriefWirelessLAN            `json:"wireless_lans,omitempty"`
...
func NewInterface(id int32) *Interface {
	this := Interface{}
	this.Id = id
	return &this
}
...
func (o *Interface) GetVdcs() []BriefVirtualDeviceContext {
	if o == nil || IsNil(o.Vdcs) {
		var ret []BriefVirtualDeviceContext
		return ret
	}
	return o.Vdcs
}
...
// SetVdcs gets a reference to the given []BriefVirtualDeviceContext and assigns it to the Vdcs field.
...
func (o *Interface) GetType() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *Interface) GetTypeOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
// SetType gets a reference to the given ChoiceString and assigns it to the Type field.
func (o *Interface) SetType(v ChoiceString) {
	o.Type = &v
}
...
func (o *Interface) SetChannelsNil() {
	o.Channels.Set(nil)
}
...
func (o *Interface) SetChannelIdNil() {
	o.ChannelId.Set(nil)
}
...
// GetBridgeInterfaces returns the BridgeInterfaces field value if set, zero value otherwise.
func (o *Interface) GetBridgeInterfaces() []NestedInterface {
	if o == nil || IsNil(o.BridgeInterfaces) {
		var ret []NestedInterface
		return ret
	}
...
// GetBridgeInterfacesOk returns a tuple with the BridgeInterfaces field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasBridgeInterfaces returns a boolean if a field has been set.
func (o *Interface) HasBridgeInterfaces() bool {
	if o != nil && !IsNil(o.BridgeInterfaces) {
		return true
	}
...
// SetBridgeInterfaces gets a reference to the given []NestedInterface and assigns it to the BridgeInterfaces field.
...
func (o *Interface) GetDuplex() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Interface) GetDuplexOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
// SetDuplex gets a reference to the given NullableChoiceString and assigns it to the Duplex field.
func (o *Interface) SetDuplex(v ChoiceString) {
	o.Duplex.Set(&v)
}
...
func (o *Interface) GetMode() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *Interface) GetModeOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Mode) {
		return nil, false
	}
	return o.Mode, true
...
// SetMode gets a reference to the given ChoiceString and assigns it to the Mode field.
func (o *Interface) SetMode(v ChoiceString) {
	o.Mode = &v
}

// GetRfRole returns the RfRole field value if set, zero value otherwise.
func (o *Interface) GetRfRole() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *Interface) GetRfRoleOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.RfRole) {
		return nil, false
	}
...
// SetRfRole gets a reference to the given ChoiceString and assigns it to the RfRole field.
func (o *Interface) SetRfRole(v ChoiceString) {
	o.RfRole = &v
}

// GetRfChannel returns the RfChannel field value if set, zero value otherwise.
func (o *Interface) GetRfChannel() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *Interface) GetRfChannelOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.RfChannel) {
		return nil, false
	}
...
// SetRfChannel gets a reference to the given ChoiceString and assigns it to the RfChannel field.
func (o *Interface) SetRfChannel(v ChoiceString) {
	o.RfChannel = &v
}

// GetPoeMode returns the PoeMode field value if set, zero value otherwise.
func (o *Interface) GetPoeMode() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *Interface) GetPoeModeOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.PoeMode) {
		return nil, false
	}
...
// SetPoeMode gets a reference to the given ChoiceString and assigns it to the PoeMode field.
func (o *Interface) SetPoeMode(v ChoiceString) {
	o.PoeMode = &v
}

// GetPoeType returns the PoeType field value if set, zero value otherwise.
func (o *Interface) GetPoeType() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *Interface) GetPoeTypeOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.PoeType) {
		return nil, false
	}
...
// SetPoeType gets a reference to the given ChoiceString and assigns it to the PoeType field.
func (o *Interface) SetPoeType(v ChoiceString) {
	o.PoeType = &v
}
...
// SetTaggedVlans gets a reference to the given []BriefVLAN and assigns it to the TaggedVlans field.
...
// SetCableEnd gets a reference to the given NullableString and assigns it to the CableEnd field.
...
// GetLinkPeers returns the LinkPeers field value if set, zero value otherwise.
func (o *Interface) GetLinkPeers() []interface{} {
	if o == nil || IsNil(o.LinkPeers) {
		var ret []interface{}
		return ret
	}
	return o.LinkPeers
...
// GetLinkPeersOk returns a tuple with the LinkPeers field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasLinkPeers returns a boolean if a field has been set.
func (o *Interface) HasLinkPeers() bool {
	if o != nil && !IsNil(o.LinkPeers) {
		return true
	}
...
// SetLinkPeers gets a reference to the given []interface{} and assigns it to the LinkPeers field.
...
// SetWirelessLans gets a reference to the given []BriefWirelessLAN and assigns it to the WirelessLans field.
...
// GetConnectedEndpointsReachable returns the ConnectedEndpointsReachable field value if set, zero value otherwise.
func (o *Interface) GetConnectedEndpointsReachable() bool {
	if o == nil || IsNil(o.ConnectedEndpointsReachable) {
		var ret bool
		return ret
	}
...
// GetConnectedEndpointsReachableOk returns a tuple with the ConnectedEndpointsReachable field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasConnectedEndpointsReachable returns a boolean if a field has been set.
func (o *Interface) HasConnectedEndpointsReachable() bool {
	if o != nil && !IsNil(o.ConnectedEndpointsReachable) {
		return true
	}
...
// SetConnectedEndpointsReachable gets a reference to the given bool and assigns it to the ConnectedEndpointsReachable field.
...
func (o *Interface) HasCountFhrpGroups() bool {
	if o != nil && !IsNil(o.CountFhrpGroups) {
		return true
	}
...
func (o Interface) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ConnectedEndpointsReachable) {
