...
func NewWirelessLinkRequest(interfaceA int32, interfaceB int32) *WirelessLinkRequest {
...
func (o *WirelessLinkRequest) GetInterfaceA() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o *WirelessLinkRequest) GetInterfaceAOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WirelessLinkRequest) SetInterfaceA(v int32) {
	o.InterfaceA = v
}

// GetInterfaceB returns the InterfaceB field value
func (o *WirelessLinkRequest) GetInterfaceB() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WirelessLinkRequest) GetInterfaceBOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WirelessLinkRequest) SetInterfaceB(v int32) {
	o.InterfaceB = v
}
...
func (o *WirelessLinkRequest) GetTenant() int32 {
...
func (o *WirelessLinkRequest) GetTenantOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WirelessLinkRequest) SetTenant(v int32) {
	o.Tenant.Set(&v)
}
...
func (o *WirelessLinkRequest) GetDistanceUnit() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WirelessLinkRequest) GetDistanceUnitOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WirelessLinkRequest) SetDistanceUnit(v string) {
...
func (o *WirelessLinkRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WirelessLinkRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WirelessLinkRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
