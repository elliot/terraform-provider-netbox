...
func NewBriefL2VPN(id int32) *BriefL2VPN {
	this := BriefL2VPN{}
	this.Id = id
	return &this
}
...
func (o *BriefL2VPN) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *BriefL2VPN) HasSlug() bool {
	if o != nil && !IsNil(o.Slug) {
		return true
	}
...
func (o *BriefL2VPN) GetType() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *BriefL2VPN) GetTypeOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *BriefL2VPN) SetType(v ChoiceString) {
	o.Type = &v
}
