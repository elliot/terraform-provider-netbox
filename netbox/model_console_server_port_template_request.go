...
func (o *ConsoleServerPortTemplateRequest) GetDeviceType() int32 {
...
func (o *ConsoleServerPortTemplateRequest) GetDeviceTypeOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ConsoleServerPortTemplateRequest) SetDeviceType(v int32) {
	o.DeviceType.Set(&v)
}
...
func (o *ConsoleServerPortTemplateRequest) GetModuleType() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ConsoleServerPortTemplateRequest) GetModuleTypeOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ConsoleServerPortTemplateRequest) SetModuleType(v int32) {
	o.ModuleType.Set(&v)
}
