...
func (o *PatchedModuleBayTemplateRequest) GetDeviceType() int32 {
...
func (o *PatchedModuleBayTemplateRequest) GetDeviceTypeOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedModuleBayTemplateRequest) SetDeviceType(v int32) {
	o.DeviceType.Set(&v)
}
...
func (o *PatchedModuleBayTemplateRequest) GetModuleType() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedModuleBayTemplateRequest) GetModuleTypeOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedModuleBayTemplateRequest) SetModuleType(v int32) {
	o.ModuleType.Set(&v)
}
