...
func NewWritableEventRuleRequest(objectTypes []string, name string, eventTypes []string, actionType string) *WritableEventRuleRequest {
...
func (o *WritableEventRuleRequest) SetActionObjectTypeNil() {
...
func (o *WritableEventRuleRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WritableEventRuleRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableEventRuleRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
