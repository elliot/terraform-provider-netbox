...
func (o *PatchedDeviceBayTemplateRequest) GetDeviceType() int32 {
...
func (o *PatchedDeviceBayTemplateRequest) GetDeviceTypeOk() (*int32, bool) {
	if o == nil || IsNil(o.DeviceType) {
		return nil, false
	}
...
func (o *PatchedDeviceBayTemplateRequest) SetDeviceType(v int32) {
	o.DeviceType = &v
}
