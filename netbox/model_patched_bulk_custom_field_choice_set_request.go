...
type PatchedBulkCustomFieldChoiceSetRequest struct {
	...
	BaseChoices  NullableString     `json:"base_choices,omitempty"`
...
func (o *PatchedBulkCustomFieldChoiceSetRequest) GetBaseChoices() string {
...
func (o *PatchedBulkCustomFieldChoiceSetRequest) GetBaseChoicesOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// SetBaseChoices gets a reference to the given NullableString and assigns it to the BaseChoices field.
func (o *PatchedBulkCustomFieldChoiceSetRequest) SetBaseChoices(v string) {
	o.BaseChoices.Set(&v)
}
...
func (o *PatchedBulkCustomFieldChoiceSetRequest) GetChoiceColors() map[string]string {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkCustomFieldChoiceSetRequest) GetChoiceColorsOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.ChoiceColors) {
		return nil, false
	}
...
// SetChoiceColors gets a reference to the given map[string]string and assigns it to the ChoiceColors field.
func (o *PatchedBulkCustomFieldChoiceSetRequest) SetChoiceColors(v map[string]string) {
	o.ChoiceColors = &v
}
...
func (o *PatchedBulkCustomFieldChoiceSetRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedBulkCustomFieldChoiceSetRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkCustomFieldChoiceSetRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
