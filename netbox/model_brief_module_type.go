...
func NewBriefModuleType(id int32) *BriefModuleType {
...
func (o *BriefModuleType) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *BriefModuleType) HasManufacturer() bool {
	if o != nil && !IsNil(o.Manufacturer) {
		return true
	}
...
func (o *BriefModuleType) HasModel() bool {
	if o != nil && !IsNil(o.Model) {
		return true
	}
...
func (o *BriefModuleType) HasModuleCount() bool {
	if o != nil && !IsNil(o.ModuleCount) {
		return true
	}
