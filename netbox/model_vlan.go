...
type VLAN struct {
	...
	QinqRole             NullableChoiceString          `json:"qinq_role,omitempty"`
...
func (o *VLAN) GetStatus() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *VLAN) GetStatusOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *VLAN) SetStatus(v ChoiceString) {
	o.Status = &v
}
...
func (o *VLAN) GetQinqRole() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *VLAN) GetQinqRoleOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
// SetQinqRole gets a reference to the given NullableChoiceString and assigns it to the QinqRole field.
func (o *VLAN) SetQinqRole(v ChoiceString) {
	o.QinqRole.Set(&v)
}
