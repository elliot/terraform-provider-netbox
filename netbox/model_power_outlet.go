...
type PowerOutlet struct {
	...
	FeedLeg     NullableChoiceString   `json:"feed_leg,omitempty"`
...
func NewPowerOutlet(id int32) *PowerOutlet {
	this := PowerOutlet{}
	this.Id = id
	return &this
}
...
func (o *PowerOutlet) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *PowerOutlet) GetType() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PowerOutlet) GetTypeOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PowerOutlet) SetType(v ChoiceString) {
	o.Type.Set(&v)
}
...
func (o *PowerOutlet) GetStatus() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *PowerOutlet) GetStatusOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *PowerOutlet) SetStatus(v ChoiceString) {
	o.Status = &v
}
...
func (o *PowerOutlet) GetFeedLeg() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PowerOutlet) GetFeedLegOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
// SetFeedLeg gets a reference to the given NullableChoiceString and assigns it to the FeedLeg field.
func (o *PowerOutlet) SetFeedLeg(v ChoiceString) {
	o.FeedLeg.Set(&v)
}
...
func (o *PowerOutlet) HasLinkPeers() bool {
	if o != nil && !IsNil(o.LinkPeers) {
		return true
	}
...
func (o *PowerOutlet) HasConnectedEndpointsReachable() bool {
	if o != nil && !IsNil(o.ConnectedEndpointsReachable) {
		return true
	}
