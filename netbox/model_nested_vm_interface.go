...
func NewNestedVMInterface(id int32) *NestedVMInterface {
...
// SetVirtualMachine gets a reference to the given NestedVirtualMachine and assigns it to the VirtualMachine field.
...
func (o *NestedVMInterface) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
