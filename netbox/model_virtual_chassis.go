...
type VirtualChassis struct {
	...
	Members              []NestedDevice         `json:"members,omitempty"`
...
func NewVirtualChassis(id int32) *VirtualChassis {
	this := VirtualChassis{}
	this.Id = id
	return &this
}
...
func (o *VirtualChassis) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *VirtualChassis) HasMembers() bool {
	if o != nil && !IsNil(o.Members) {
		return true
	}
...
// SetMembers gets a reference to the given []NestedDevice and assigns it to the Members field.
