...
func NewPowerPortTemplate(id int32) *PowerPortTemplate {
...
func (o *PowerPortTemplate) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *PowerPortTemplate) GetType() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PowerPortTemplate) GetTypeOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PowerPortTemplate) SetType(v ChoiceString) {
	o.Type.Set(&v)
}
