...
func NewFrontPortTemplate(id int32) *FrontPortTemplate {
...
func (o *FrontPortTemplate) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *FrontPortTemplate) GetType() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *FrontPortTemplate) GetTypeOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *FrontPortTemplate) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *FrontPortTemplate) SetType(v ChoiceString) {
	o.Type = &v
}
