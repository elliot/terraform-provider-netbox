...
func (o *TenantRequest) GetGroup() int32 {
...
func (o *TenantRequest) GetGroupOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TenantRequest) SetGroup(v int32) {
	o.Group.Set(&v)
}
...
func (o *TenantRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TenantRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TenantRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
