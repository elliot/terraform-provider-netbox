...
func (o *CustomFieldChoiceSetRequest) GetChoiceColors() map[string]string {
...
// and a boolean to check if the value has been set.
func (o *CustomFieldChoiceSetRequest) GetChoiceColorsOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.ChoiceColors) {
		return nil, false
	}
...
func (o *CustomFieldChoiceSetRequest) SetChoiceColors(v map[string]string) {
	o.ChoiceColors = &v
}
...
func (o *CustomFieldChoiceSetRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CustomFieldChoiceSetRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CustomFieldChoiceSetRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
