...
func (o *PatchedBulkProviderRequest) GetOwner() int32 {
...
func (o *PatchedBulkProviderRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkProviderRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
