...
type PaginatedNotificationGroupList struct {
	...
	Results              []NotificationGroup `json:"results,omitempty"`
...
func NewPaginatedNotificationGroupList() *PaginatedNotificationGroupList {
...
func (o *PaginatedNotificationGroupList) HasCount() bool {
	if o != nil && !IsNil(o.Count) {
		return true
	}
...
func (o *PaginatedNotificationGroupList) HasResults() bool {
	if o != nil && !IsNil(o.Results) {
		return true
	}
...
// SetResults gets a reference to the given []NotificationGroup and assigns it to the Results field.
