...
func (o *PrefixRequest) GetVrf() int32 {
...
func (o *PrefixRequest) GetVrfOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PrefixRequest) SetVrf(v int32) {
	o.Vrf.Set(&v)
}
...
func (o *PrefixRequest) GetTenant() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PrefixRequest) GetTenantOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PrefixRequest) SetTenant(v int32) {
	o.Tenant.Set(&v)
}
...
func (o *PrefixRequest) GetVlan() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PrefixRequest) GetVlanOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PrefixRequest) SetVlan(v int32) {
	o.Vlan.Set(&v)
}
...
func (o *PrefixRequest) GetRole() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PrefixRequest) GetRoleOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PrefixRequest) SetRole(v int32) {
	o.Role.Set(&v)
}
...
func (o *PrefixRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PrefixRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PrefixRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
