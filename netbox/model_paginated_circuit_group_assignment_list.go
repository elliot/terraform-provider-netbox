...
type PaginatedCircuitGroupAssignmentList struct {
	...
	Results              []CircuitGroupAssignment `json:"results,omitempty"`
...
func NewPaginatedCircuitGroupAssignmentList() *PaginatedCircuitGroupAssignmentList {
...
func (o *PaginatedCircuitGroupAssignmentList) HasCount() bool {
	if o != nil && !IsNil(o.Count) {
		return true
	}
...
func (o *PaginatedCircuitGroupAssignmentList) HasResults() bool {
	if o != nil && !IsNil(o.Results) {
		return true
	}
...
// SetResults gets a reference to the given []CircuitGroupAssignment and assigns it to the Results field.
