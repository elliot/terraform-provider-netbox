...
type InterfaceTemplate struct {
	...
	Parent               NullableNestedInterfaceTemplate `json:"parent,omitempty"`
	Bridge               NullableNestedInterfaceTemplate `json:"bridge,omitempty"`
	PoeMode              NullableChoiceString            `json:"poe_mode,omitempty"`
	PoeType              NullableChoiceString            `json:"poe_type,omitempty"`
	RfRole               NullableChoiceString            `json:"rf_role,omitempty"`
...
func NewInterfaceTemplate(id int32) *InterfaceTemplate {
...
func (o *InterfaceTemplate) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *InterfaceTemplate) GetType() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *InterfaceTemplate) GetTypeOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *InterfaceTemplate) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *InterfaceTemplate) SetType(v ChoiceString) {
	o.Type = &v
}
...
func (o *InterfaceTemplate) SetChannelsNil() {
	o.Channels.Set(nil)
}
...
func (o *InterfaceTemplate) SetChannelIdNil() {
	o.ChannelId.Set(nil)
}
...
// SetParent gets a reference to the given NullableNestedInterfaceTemplate and assigns it to the Parent field.
func (o *InterfaceTemplate) SetParent(v NestedInterfaceTemplate) {
	o.Parent.Set(&v)
}

// SetParentNil sets the value for Parent to be an explicit nil
func (o *InterfaceTemplate) SetParentNil() {
	o.Parent.Set(nil)
}
...
func (o *InterfaceTemplate) GetPoeMode() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InterfaceTemplate) GetPoeModeOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
// SetPoeMode gets a reference to the given NullableChoiceString and assigns it to the PoeMode field.
func (o *InterfaceTemplate) SetPoeMode(v ChoiceString) {
	o.PoeMode.Set(&v)
}
...
func (o *InterfaceTemplate) GetPoeType() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InterfaceTemplate) GetPoeTypeOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
// SetPoeType gets a reference to the given NullableChoiceString and assigns it to the PoeType field.
func (o *InterfaceTemplate) SetPoeType(v ChoiceString) {
	o.PoeType.Set(&v)
}
...
func (o *InterfaceTemplate) GetRfRole() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InterfaceTemplate) GetRfRoleOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
// SetRfRole gets a reference to the given NullableChoiceString and assigns it to the RfRole field.
func (o *InterfaceTemplate) SetRfRole(v ChoiceString) {
	o.RfRole.Set(&v)
}
