...
type PatchedBulkWirelessLinkRequest struct {
	...
	DistanceUnit         NullableString         `json:"distance_unit,omitempty"`
...
func (o *PatchedBulkWirelessLinkRequest) GetInterfaceA() int32 {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkWirelessLinkRequest) GetInterfaceAOk() (*int32, bool) {
	if o == nil || IsNil(o.InterfaceA) {
		return nil, false
	}
...
func (o *PatchedBulkWirelessLinkRequest) SetInterfaceA(v int32) {
	o.InterfaceA = &v
}

// GetInterfaceB returns the InterfaceB field value if set, zero value otherwise.
func (o *PatchedBulkWirelessLinkRequest) GetInterfaceB() int32 {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkWirelessLinkRequest) GetInterfaceBOk() (*int32, bool) {
	if o == nil || IsNil(o.InterfaceB) {
		return nil, false
	}
...
func (o *PatchedBulkWirelessLinkRequest) SetInterfaceB(v int32) {
	o.InterfaceB = &v
}
...
func (o *PatchedBulkWirelessLinkRequest) GetStatus() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkWirelessLinkRequest) GetStatusOk() (*string, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *PatchedBulkWirelessLinkRequest) SetStatus(v string) {
	o.Status = &v
}

// GetTenant returns the Tenant field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PatchedBulkWirelessLinkRequest) GetTenant() int32 {
...
func (o *PatchedBulkWirelessLinkRequest) GetTenantOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkWirelessLinkRequest) SetTenant(v int32) {
	o.Tenant.Set(&v)
}
...
func (o *PatchedBulkWirelessLinkRequest) GetAuthType() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkWirelessLinkRequest) GetAuthTypeOk() (*string, bool) {
	if o == nil || IsNil(o.AuthType) {
		return nil, false
	}
...
func (o *PatchedBulkWirelessLinkRequest) SetAuthType(v string) {
	o.AuthType = &v
}

// GetAuthCipher returns the AuthCipher field value if set, zero value otherwise.
func (o *PatchedBulkWirelessLinkRequest) GetAuthCipher() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkWirelessLinkRequest) GetAuthCipherOk() (*string, bool) {
	if o == nil || IsNil(o.AuthCipher) {
		return nil, false
	}
...
func (o *PatchedBulkWirelessLinkRequest) SetAuthCipher(v string) {
	o.AuthCipher = &v
}
...
func (o *PatchedBulkWirelessLinkRequest) GetDistanceUnit() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedBulkWirelessLinkRequest) GetDistanceUnitOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// SetDistanceUnit gets a reference to the given NullableString and assigns it to the DistanceUnit field.
func (o *PatchedBulkWirelessLinkRequest) SetDistanceUnit(v string) {
...
func (o *PatchedBulkWirelessLinkRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedBulkWirelessLinkRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkWirelessLinkRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
