...
func NewTokenProvision(id int32) *TokenProvision {
	this := TokenProvision{}
	this.Id = id
	return &this
}
...
func (o *TokenProvision) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *TokenProvision) GetVersion() int32 {
...
// and a boolean to check if the value has been set.
func (o *TokenProvision) GetVersionOk() (*int32, bool) {
	if o == nil || IsNil(o.Version) {
		return nil, false
	}
...
func (o *TokenProvision) SetVersion(v int32) {
	o.Version = &v
}
...
func (o *TokenProvision) HasUser() bool {
	if o != nil && !IsNil(o.User) {
		return true
	}
...
func (o *TokenProvision) HasKey() bool {
	if o != nil && !IsNil(o.Key) {
		return true
	}
...
func (o *TokenProvision) HasLastUsed() bool {
	if o != nil && !IsNil(o.LastUsed) {
		return true
	}
