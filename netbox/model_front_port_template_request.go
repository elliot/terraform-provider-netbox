...
func NewFrontPortTemplateRequest(name string, type_ string) *FrontPortTemplateRequest {
...
func (o *FrontPortTemplateRequest) GetDeviceType() int32 {
...
func (o *FrontPortTemplateRequest) GetDeviceTypeOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *FrontPortTemplateRequest) SetDeviceType(v int32) {
	o.DeviceType.Set(&v)
}
...
func (o *FrontPortTemplateRequest) GetModuleType() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *FrontPortTemplateRequest) GetModuleTypeOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *FrontPortTemplateRequest) SetModuleType(v int32) {
	o.ModuleType.Set(&v)
}
