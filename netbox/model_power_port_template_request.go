...
func (o *PowerPortTemplateRequest) GetDeviceType() int32 {
...
func (o *PowerPortTemplateRequest) GetDeviceTypeOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PowerPortTemplateRequest) SetDeviceType(v int32) {
	o.DeviceType.Set(&v)
}
...
func (o *PowerPortTemplateRequest) GetModuleType() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PowerPortTemplateRequest) GetModuleTypeOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PowerPortTemplateRequest) SetModuleType(v int32) {
	o.ModuleType.Set(&v)
}
