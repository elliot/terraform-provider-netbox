...
func NewPowerOutletTemplate(id int32) *PowerOutletTemplate {
...
func (o *PowerOutletTemplate) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *PowerOutletTemplate) GetType() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PowerOutletTemplate) GetTypeOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PowerOutletTemplate) SetType(v ChoiceString) {
	o.Type.Set(&v)
}
...
func (o *PowerOutletTemplate) GetFeedLeg() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PowerOutletTemplate) GetFeedLegOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PowerOutletTemplate) SetFeedLeg(v ChoiceString) {
	o.FeedLeg.Set(&v)
}
