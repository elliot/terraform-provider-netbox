...
type ContactAssignment struct {
	...
	Contact              *BriefContact            `json:"contact,omitempty"`
...
func NewContactAssignment(id int32) *ContactAssignment {
...
func (o *ContactAssignment) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *ContactAssignment) HasObjectType() bool {
	if o != nil && !IsNil(o.ObjectType) {
		return true
	}
...
func (o *ContactAssignment) HasObjectId() bool {
	if o != nil && !IsNil(o.ObjectId) {
		return true
	}
...
func (o *ContactAssignment) HasContact() bool {
	if o != nil && !IsNil(o.Contact) {
		return true
	}
...
// SetContact gets a reference to the given BriefContact and assigns it to the Contact field.
...
func (o *ContactAssignment) GetPriority() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *ContactAssignment) GetPriorityOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Priority) {
		return nil, false
	}
...
func (o *ContactAssignment) SetPriority(v ChoiceString) {
	o.Priority = &v
}
