...
func NewWritableVirtualDeviceContextRequest(name string, device int32, status string) *WritableVirtualDeviceContextRequest {
...
func (o *WritableVirtualDeviceContextRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WritableVirtualDeviceContextRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableVirtualDeviceContextRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
