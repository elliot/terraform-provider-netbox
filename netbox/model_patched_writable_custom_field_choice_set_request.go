...
func (o *PatchedWritableCustomFieldChoiceSetRequest) GetChoiceColors() map[string]string {
...
// and a boolean to check if the value has been set.
func (o *PatchedWritableCustomFieldChoiceSetRequest) GetChoiceColorsOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.ChoiceColors) {
		return nil, false
	}
...
func (o *PatchedWritableCustomFieldChoiceSetRequest) SetChoiceColors(v map[string]string) {
	o.ChoiceColors = &v
}
...
func (o *PatchedWritableCustomFieldChoiceSetRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedWritableCustomFieldChoiceSetRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableCustomFieldChoiceSetRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
