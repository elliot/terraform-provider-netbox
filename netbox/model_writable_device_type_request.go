...
func (o *WritableDeviceTypeRequest) GetCoolingMethod() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WritableDeviceTypeRequest) GetCoolingMethodOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableDeviceTypeRequest) SetCoolingMethod(v string) {
	o.CoolingMethod.Set(&v)
}

// SetCoolingMethodNil sets the value for CoolingMethod to be an explicit nil
func (o *WritableDeviceTypeRequest) SetCoolingMethodNil() {
...
func (o *WritableDeviceTypeRequest) SetEndOfLifeNil() {
	o.EndOfLife.Set(nil)
}
...
func (o *WritableDeviceTypeRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WritableDeviceTypeRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableDeviceTypeRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
