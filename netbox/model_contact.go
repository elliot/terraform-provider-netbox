...
type Contact struct {
	...
	Groups               []BriefContactGroup    `json:"groups,omitempty"`
...
func NewContact(id int32) *Contact {
	this := Contact{}
	this.Id = id
	return &this
}
...
// SetGroups gets a reference to the given []BriefContactGroup and assigns it to the Groups field.
