...
func NewConfigContextProfile(id int32) *ConfigContextProfile {
...
func (o *ConfigContextProfile) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *ConfigContextProfile) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ConfigContextProfile) HasDataPath() bool {
	if o != nil && !IsNil(o.DataPath) {
		return true
	}
