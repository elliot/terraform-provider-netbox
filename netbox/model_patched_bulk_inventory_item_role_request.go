...
func (o *PatchedBulkInventoryItemRoleRequest) GetOwner() int32 {
...
func (o *PatchedBulkInventoryItemRoleRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkInventoryItemRoleRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
