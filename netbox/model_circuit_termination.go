...
type CircuitTermination struct {
	...
	Circuit    *BriefCircuit `json:"circuit,omitempty"`
	// * `A` - A * `Z` - Z
...
func NewCircuitTermination(id int32) *CircuitTermination {
...
func (o *CircuitTermination) HasCircuit() bool {
	if o != nil && !IsNil(o.Circuit) {
		return true
	}
...
// SetCircuit gets a reference to the given BriefCircuit and assigns it to the Circuit field.
...
func (o *CircuitTermination) HasTermSide() bool {
	if o != nil && !IsNil(o.TermSide) {
		return true
	}
...
func (o *CircuitTermination) HasLinkPeers() bool {
	if o != nil && !IsNil(o.LinkPeers) {
		return true
	}
