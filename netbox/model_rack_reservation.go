...
func NewRackReservation(id int32) *RackReservation {
...
func (o *RackReservation) HasRack() bool {
	if o != nil && !IsNil(o.Rack) {
		return true
	}
...
// SetRack gets a reference to the given BriefRack and assigns it to the Rack field.
...
func (o *RackReservation) HasUnits() bool {
	if o != nil && !IsNil(o.Units) {
		return true
	}
...
func (o *RackReservation) HasUnitCount() bool {
	if o != nil && !IsNil(o.UnitCount) {
		return true
	}
...
func (o *RackReservation) GetStatus() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *RackReservation) GetStatusOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *RackReservation) SetStatus(v ChoiceString) {
	o.Status = &v
}
...
func (o *RackReservation) HasDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
