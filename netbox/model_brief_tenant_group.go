...
func NewBriefTenantGroup(id int32) *BriefTenantGroup {
...
func (o *BriefTenantGroup) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *BriefTenantGroup) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *BriefTenantGroup) HasSlug() bool {
	if o != nil && !IsNil(o.Slug) {
		return true
	}
