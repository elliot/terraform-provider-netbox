...
func NewRackType(id int32) *RackType {
	this := RackType{}
	this.Id = id
	return &this
}
...
func (o *RackType) HasManufacturer() bool {
	if o != nil && !IsNil(o.Manufacturer) {
		return true
	}
...
func (o *RackType) GetFormFactor() ChoiceString {
...
func (o *RackType) GetFormFactorOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RackType) SetFormFactor(v ChoiceString) {
	o.FormFactor.Set(&v)
}
...
func (o *RackType) GetWidth() ChoiceInteger {
...
// and a boolean to check if the value has been set.
func (o *RackType) GetWidthOk() (*ChoiceInteger, bool) {
	if o == nil || IsNil(o.Width) {
		return nil, false
	}
	return o.Width, true
...
func (o *RackType) SetWidth(v ChoiceInteger) {
	o.Width = &v
}
...
func (o *RackType) GetOuterUnit() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *RackType) GetOuterUnitOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RackType) SetOuterUnit(v ChoiceString) {
	o.OuterUnit.Set(&v)
}
...
func (o *RackType) GetWeightUnit() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *RackType) GetWeightUnitOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RackType) SetWeightUnit(v ChoiceString) {
	o.WeightUnit.Set(&v)
}
...
func (o *RackType) GetCoolingCapability() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *RackType) GetCoolingCapabilityOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RackType) SetCoolingCapacityNil() {
