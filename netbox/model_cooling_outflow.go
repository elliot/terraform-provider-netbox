...
func NewCoolingOutflow(id int32) *CoolingOutflow {
	this := CoolingOutflow{}
	this.Id = id
	return &this
}
...
func (o *CoolingOutflow) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *CoolingOutflow) HasDisplay() bool {
	if o != nil && !IsNil(o.Display) {
		return true
	}
...
func (o *CoolingOutflow) HasDevice() bool {
	if o != nil && !IsNil(o.Device) {
		return true
	}
...
func (o *CoolingOutflow) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *CoolingOutflow) GetType() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CoolingOutflow) GetTypeOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CoolingOutflow) SetType(v ChoiceString) {
	o.Type.Set(&v)
}
...
func (o *CoolingOutflow) GetDiameterUnit() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CoolingOutflow) GetDiameterUnitOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CoolingOutflow) SetDiameterUnit(v ChoiceString) {
