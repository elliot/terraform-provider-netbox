...
func (o *WritableCircuitRequest) GetDistanceUnit() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WritableCircuitRequest) GetDistanceUnitOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableCircuitRequest) SetDistanceUnit(v string) {
...
func (o *WritableCircuitRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WritableCircuitRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableCircuitRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
