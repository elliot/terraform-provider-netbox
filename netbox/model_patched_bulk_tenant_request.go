...
func (o *PatchedBulkTenantRequest) GetGroup() int32 {
...
func (o *PatchedBulkTenantRequest) GetGroupOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkTenantRequest) SetGroup(v int32) {
	o.Group.Set(&v)
}
...
func (o *PatchedBulkTenantRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedBulkTenantRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkTenantRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
