...
func (o *WritableDataSourceRequest) GetSyncInterval() int32 {
...
func (o *WritableDataSourceRequest) GetSyncIntervalOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableDataSourceRequest) SetSyncInterval(v int32) {
...
func (o *WritableDataSourceRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WritableDataSourceRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableDataSourceRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
