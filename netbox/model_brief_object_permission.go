...
func NewBriefObjectPermission(id int32) *BriefObjectPermission {
...
func (o *BriefObjectPermission) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *BriefObjectPermission) HasDisplay() bool {
	if o != nil && !IsNil(o.Display) {
		return true
	}
...
func (o *BriefObjectPermission) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *BriefObjectPermission) HasObjectTypes() bool {
	if o != nil && !IsNil(o.ObjectTypes) {
		return true
	}
...
func (o *BriefObjectPermission) HasActions() bool {
	if o != nil && !IsNil(o.Actions) {
		return true
	}
