...
func (o *PatchedBulkModuleBayTypeRequest) GetManufacturer() int32 {
...
func (o *PatchedBulkModuleBayTypeRequest) GetManufacturerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkModuleBayTypeRequest) SetManufacturer(v int32) {
...
func (o *PatchedBulkModuleBayTypeRequest) GetColor() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkModuleBayTypeRequest) GetColorOk() (*string, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *PatchedBulkModuleBayTypeRequest) SetColor(v string) {
	o.Color = &v
}
...
func (o *PatchedBulkModuleBayTypeRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedBulkModuleBayTypeRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkModuleBayTypeRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
