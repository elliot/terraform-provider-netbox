...
func (o *PatchedWritableInventoryItemRequest) GetStatus() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedWritableInventoryItemRequest) GetStatusOk() (*string, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *PatchedWritableInventoryItemRequest) SetStatus(v string) {
	o.Status = &v
}
...
func (o *PatchedWritableInventoryItemRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedWritableInventoryItemRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableInventoryItemRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
