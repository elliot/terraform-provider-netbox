...
func NewBriefVirtualCircuit(id int32) *BriefVirtualCircuit {
...
func (o *BriefVirtualCircuit) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *BriefVirtualCircuit) HasCid() bool {
	if o != nil && !IsNil(o.Cid) {
		return true
	}
...
func (o *BriefVirtualCircuit) HasProviderNetwork() bool {
	if o != nil && !IsNil(o.ProviderNetwork) {
		return true
	}
