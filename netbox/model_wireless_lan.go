...
func NewWirelessLAN(id int32) *WirelessLAN {
	this := WirelessLAN{}
	this.Id = id
	return &this
}
...
func (o *WirelessLAN) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *WirelessLAN) HasSsid() bool {
	if o != nil && !IsNil(o.Ssid) {
		return true
	}
...
func (o *WirelessLAN) GetStatus() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *WirelessLAN) GetStatusOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *WirelessLAN) SetStatus(v ChoiceString) {
	o.Status = &v
}
...
func (o *WirelessLAN) GetAuthType() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *WirelessLAN) GetAuthTypeOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.AuthType) {
		return nil, false
	}
...
func (o *WirelessLAN) SetAuthType(v ChoiceString) {
	o.AuthType = &v
}

// GetAuthCipher returns the AuthCipher field value if set, zero value otherwise.
func (o *WirelessLAN) GetAuthCipher() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *WirelessLAN) GetAuthCipherOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.AuthCipher) {
		return nil, false
	}
...
func (o *WirelessLAN) SetAuthCipher(v ChoiceString) {
	o.AuthCipher = &v
}
