...
func (o *WritableCustomFieldChoiceSetRequest) GetChoiceColors() map[string]string {
...
// and a boolean to check if the value has been set.
func (o *WritableCustomFieldChoiceSetRequest) GetChoiceColorsOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.ChoiceColors) {
		return nil, false
	}
...
func (o *WritableCustomFieldChoiceSetRequest) SetChoiceColors(v map[string]string) {
	o.ChoiceColors = &v
}
...
func (o *WritableCustomFieldChoiceSetRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WritableCustomFieldChoiceSetRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableCustomFieldChoiceSetRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
