...
func NewImageAttachment(id int32) *ImageAttachment {
...
func (o *ImageAttachment) HasObjectType() bool {
	if o != nil && !IsNil(o.ObjectType) {
		return true
	}
...
func (o *ImageAttachment) HasObjectId() bool {
	if o != nil && !IsNil(o.ObjectId) {
		return true
	}
...
func (o *ImageAttachment) HasImageHeight() bool {
	if o != nil && !IsNil(o.ImageHeight) {
		return true
	}
...
func (o *ImageAttachment) HasImageWidth() bool {
	if o != nil && !IsNil(o.ImageWidth) {
		return true
	}
...
func (o *ImageAttachment) HasImageSize() bool {
	if o != nil && !IsNil(o.ImageSize) {
		return true
	}
