...
func (o *BulkCircuitGroupRequest) GetTenant() int32 {
...
func (o *BulkCircuitGroupRequest) GetTenantOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkCircuitGroupRequest) SetTenant(v int32) {
	o.Tenant.Set(&v)
}
...
func (o *BulkCircuitGroupRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkCircuitGroupRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkCircuitGroupRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
