...
func NewObjectPermission(id int32) *ObjectPermission {
...
func (o *ObjectPermission) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ObjectPermission) HasObjectTypes() bool {
	if o != nil && !IsNil(o.ObjectTypes) {
		return true
	}
...
func (o *ObjectPermission) HasActions() bool {
	if o != nil && !IsNil(o.Actions) {
		return true
	}
