...
func NewNestedWirelessLANGroup(id int32) *NestedWirelessLANGroup {
...
func (o *NestedWirelessLANGroup) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *NestedWirelessLANGroup) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *NestedWirelessLANGroup) HasSlug() bool {
	if o != nil && !IsNil(o.Slug) {
		return true
	}
