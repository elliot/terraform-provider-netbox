...
type NotificationGroup struct {
	...
	Groups               []BriefGroup `json:"groups,omitempty"`
	Users                []BriefUser  `json:"users,omitempty"`
...
func NewNotificationGroup(id int32) *NotificationGroup {
...
func (o *NotificationGroup) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *NotificationGroup) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *NotificationGroup) GetGroups() []BriefGroup {
...
// and a boolean to check if the value has been set.
func (o *NotificationGroup) GetGroupsOk() ([]BriefGroup, bool) {
	if o == nil || IsNil(o.Groups) {
		return nil, false
	}
...
// SetGroups gets a reference to the given []BriefGroup and assigns it to the Groups field.
func (o *NotificationGroup) SetGroups(v []BriefGroup) {
	o.Groups = v
}

// GetUsers returns the Users field value if set, zero value otherwise.
func (o *NotificationGroup) GetUsers() []BriefUser {
...
// and a boolean to check if the value has been set.
func (o *NotificationGroup) GetUsersOk() ([]BriefUser, bool) {
	if o == nil || IsNil(o.Users) {
		return nil, false
	}
	return o.Users, true
...
// SetUsers gets a reference to the given []BriefUser and assigns it to the Users field.
func (o *NotificationGroup) SetUsers(v []BriefUser) {
	o.Users = v
}
