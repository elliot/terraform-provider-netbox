...
func (o *PatchedWebhookRequest) SetTimeoutNil() {
	o.Timeout.Set(nil)
}
...
func (o *PatchedWebhookRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedWebhookRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWebhookRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
