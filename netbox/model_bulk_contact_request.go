...
func (o *BulkContactRequest) GetEmail() string {
...
// and a boolean to check if the value has been set.
func (o *BulkContactRequest) GetEmailOk() (*string, bool) {
	if o == nil || IsNil(o.Email) {
		return nil, false
	}
	return o.Email, true
...
func (o *BulkContactRequest) SetEmail(v string) {
	o.Email = &v
}
...
func (o *BulkContactRequest) GetLink() string {
...
// and a boolean to check if the value has been set.
func (o *BulkContactRequest) GetLinkOk() (*string, bool) {
	if o == nil || IsNil(o.Link) {
		return nil, false
	}
	return o.Link, true
...
func (o *BulkContactRequest) SetLink(v string) {
	o.Link = &v
}
...
func (o *BulkContactRequest) GetOwner() int32 {
...
func (o *BulkContactRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkContactRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
