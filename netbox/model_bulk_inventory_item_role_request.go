...
func (o *BulkInventoryItemRoleRequest) GetOwner() int32 {
...
func (o *BulkInventoryItemRoleRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkInventoryItemRoleRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
