...
type VirtualCircuitTermination struct {
	...
	VirtualCircuit       *BriefVirtualCircuit   `json:"virtual_circuit,omitempty"`
	Role                 *ChoiceString          `json:"role,omitempty"`
	Interface            *BriefInterface        `json:"interface,omitempty"`
...
func NewVirtualCircuitTermination(id int32) *VirtualCircuitTermination {
...
func (o *VirtualCircuitTermination) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *VirtualCircuitTermination) HasVirtualCircuit() bool {
	if o != nil && !IsNil(o.VirtualCircuit) {
		return true
	}
...
// SetVirtualCircuit gets a reference to the given BriefVirtualCircuit and assigns it to the VirtualCircuit field.
func (o *VirtualCircuitTermination) SetVirtualCircuit(v BriefVirtualCircuit) {
	o.VirtualCircuit = &v
}

// GetRole returns the Role field value if set, zero value otherwise.
func (o *VirtualCircuitTermination) GetRole() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *VirtualCircuitTermination) GetRoleOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Role) {
		return nil, false
	}
	return o.Role, true
...
func (o *VirtualCircuitTermination) SetRole(v ChoiceString) {
	o.Role = &v
}
...
func (o *VirtualCircuitTermination) HasInterface() bool {
	if o != nil && !IsNil(o.Interface) {
		return true
	}
...
// SetInterface gets a reference to the given BriefInterface and assigns it to the Interface field.
