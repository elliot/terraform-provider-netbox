...
func (o *PatchedBulkFHRPGroupRequest) GetProtocol() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkFHRPGroupRequest) GetProtocolOk() (*string, bool) {
	if o == nil || IsNil(o.Protocol) {
		return nil, false
	}
...
func (o *PatchedBulkFHRPGroupRequest) SetProtocol(v string) {
	o.Protocol = &v
}
...
func (o *PatchedBulkFHRPGroupRequest) GetAuthType() string {
...
func (o *PatchedBulkFHRPGroupRequest) GetAuthTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkFHRPGroupRequest) SetAuthType(v string) {
	o.AuthType.Set(&v)
}
...
func (o *PatchedBulkFHRPGroupRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedBulkFHRPGroupRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkFHRPGroupRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
