...
func (o *PatchedCircuitTypeRequest) GetOwner() int32 {
...
func (o *PatchedCircuitTypeRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedCircuitTypeRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
