...
func (o *CircuitGroupRequest) GetTenant() int32 {
...
func (o *CircuitGroupRequest) GetTenantOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CircuitGroupRequest) SetTenant(v int32) {
	o.Tenant.Set(&v)
}
...
func (o *CircuitGroupRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CircuitGroupRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CircuitGroupRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
