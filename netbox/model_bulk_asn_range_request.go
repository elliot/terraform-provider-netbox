...
func NewBulkASNRangeRequest(id int32, name string, slug string, rir int32, start int64, end int64) *BulkASNRangeRequest {
...
func (o *BulkASNRangeRequest) GetRir() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BulkASNRangeRequest) GetRirOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Rir, true
...
func (o *BulkASNRangeRequest) SetRir(v int32) {
	o.Rir = v
}
...
func (o *BulkASNRangeRequest) GetTenant() int32 {
...
func (o *BulkASNRangeRequest) GetTenantOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkASNRangeRequest) SetTenant(v int32) {
	o.Tenant.Set(&v)
}
...
func (o *BulkASNRangeRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkASNRangeRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkASNRangeRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
