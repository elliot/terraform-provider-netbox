...
func (o *WritableVLANRequest) GetQinqRole() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WritableVLANRequest) GetQinqRoleOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableVLANRequest) SetQinqRole(v string) {
	o.QinqRole.Set(&v)
}
...
func (o *WritableVLANRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WritableVLANRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableVLANRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
