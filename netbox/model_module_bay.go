...
type ModuleBay struct {
	...
	IsModuleCompatible   *bool                  `json:"is_module_compatible,omitempty"`
...
func NewModuleBay(id int32) *ModuleBay {
	this := ModuleBay{}
	this.Id = id
	return &this
}
...
func (o *ModuleBay) HasDisplay() bool {
	if o != nil && !IsNil(o.Display) {
		return true
	}
...
func (o *ModuleBay) HasOccupied() bool {
	if o != nil && !IsNil(o.Occupied) {
		return true
	}
...
// GetIsModuleCompatible returns the IsModuleCompatible field value if set, zero value otherwise.
func (o *ModuleBay) GetIsModuleCompatible() bool {
	if o == nil || IsNil(o.IsModuleCompatible) {
		var ret bool
		return ret
	}
	return *o.IsModuleCompatible
}

// GetIsModuleCompatibleOk returns a tuple with the IsModuleCompatible field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ModuleBay) GetIsModuleCompatibleOk() (*bool, bool) {
	if o == nil || IsNil(o.IsModuleCompatible) {
		return nil, false
	}
	return o.IsModuleCompatible, true
}

// HasIsModuleCompatible returns a boolean if a field has been set.
func (o *ModuleBay) HasIsModuleCompatible() bool {
	if o != nil && !IsNil(o.IsModuleCompatible) {
		return true
	}
...
// SetIsModuleCompatible gets a reference to the given bool and assigns it to the IsModuleCompatible field.
func (o *ModuleBay) SetIsModuleCompatible(v bool) {
	o.IsModuleCompatible = &v
}
...
func (o ModuleBay) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsModuleCompatible) {
		toSerialize["is_module_compatible"] = o.IsModuleCompatible
	}
...
func (o *ModuleBay) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ModuleBay(varModuleBay)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "is_module_compatible")
