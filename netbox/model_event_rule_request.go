...
func NewEventRuleRequest(objectTypes []string, name string, eventTypes []string, actionType string) *EventRuleRequest {
...
func (o *EventRuleRequest) SetActionObjectTypeNil() {
...
func (o *EventRuleRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *EventRuleRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EventRuleRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
