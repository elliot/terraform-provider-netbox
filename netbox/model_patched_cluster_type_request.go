...
func (o *PatchedClusterTypeRequest) GetOwner() int32 {
...
func (o *PatchedClusterTypeRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedClusterTypeRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
