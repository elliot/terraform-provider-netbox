...
func NewBriefManufacturer(id int32) *BriefManufacturer {
...
func (o *BriefManufacturer) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *BriefManufacturer) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *BriefManufacturer) HasSlug() bool {
	if o != nil && !IsNil(o.Slug) {
		return true
	}
