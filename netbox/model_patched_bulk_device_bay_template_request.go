...
func (o *PatchedBulkDeviceBayTemplateRequest) GetDeviceType() int32 {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkDeviceBayTemplateRequest) GetDeviceTypeOk() (*int32, bool) {
	if o == nil || IsNil(o.DeviceType) {
		return nil, false
	}
...
func (o *PatchedBulkDeviceBayTemplateRequest) SetDeviceType(v int32) {
	o.DeviceType = &v
}
