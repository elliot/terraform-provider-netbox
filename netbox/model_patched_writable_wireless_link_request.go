...
type PatchedWritableWirelessLinkRequest struct {
	...
	AuthCipher NullableString  `json:"auth_cipher,omitempty"`
...
// SetAuthCipher gets a reference to the given NullableString and assigns it to the AuthCipher field.
...
func (o *PatchedWritableWirelessLinkRequest) GetDistanceUnit() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedWritableWirelessLinkRequest) GetDistanceUnitOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableWirelessLinkRequest) SetDistanceUnit(v string) {
...
func (o *PatchedWritableWirelessLinkRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedWritableWirelessLinkRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableWirelessLinkRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
