...
func (o *PatchedClusterGroupRequest) GetOwner() int32 {
...
func (o *PatchedClusterGroupRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedClusterGroupRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
