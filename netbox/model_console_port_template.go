...
func NewConsolePortTemplate(id int32) *ConsolePortTemplate {
...
func (o *ConsolePortTemplate) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ConsolePortTemplate) GetType() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *ConsolePortTemplate) GetTypeOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *ConsolePortTemplate) SetType(v ChoiceString) {
	o.Type = &v
}
