...
func NewAggregate(id int32) *Aggregate {
	this := Aggregate{}
	this.Id = id
	return &this
}
...
func (o *Aggregate) GetFamily() ChoiceInteger {
...
// and a boolean to check if the value has been set.
func (o *Aggregate) GetFamilyOk() (*ChoiceInteger, bool) {
	if o == nil || IsNil(o.Family) {
		return nil, false
	}
...
func (o *Aggregate) SetFamily(v ChoiceInteger) {
	o.Family = &v
}
...
func (o *Aggregate) HasPrefix() bool {
	if o != nil && !IsNil(o.Prefix) {
		return true
	}
...
// SetRir gets a reference to the given BriefRIR and assigns it to the Rir field.
