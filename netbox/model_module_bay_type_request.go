...
// checks if the ModuleBayTypeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModuleBayTypeRequest{}

// ModuleBayTypeRequest Base serializer class for models inheriting from PrimaryModel.
type ModuleBayTypeRequest struct {
...
type _ModuleBayTypeRequest ModuleBayTypeRequest
...
func (o *ModuleBayTypeRequest) GetManufacturer() int32 {
...
func (o *ModuleBayTypeRequest) GetManufacturerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ModuleBayTypeRequest) SetManufacturer(v int32) {
	o.Manufacturer.Set(&v)
}

// SetManufacturerNil sets the value for Manufacturer to be an explicit nil
func (o *ModuleBayTypeRequest) SetManufacturerNil() {
...
func (o *ModuleBayTypeRequest) GetColor() string {
...
// and a boolean to check if the value has been set.
func (o *ModuleBayTypeRequest) GetColorOk() (*string, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *ModuleBayTypeRequest) SetColor(v string) {
	o.Color = &v
}
...
func (o *ModuleBayTypeRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ModuleBayTypeRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ModuleBayTypeRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}

// SetOwnerNil sets the value for Owner to be an explicit nil
func (o *ModuleBayTypeRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o ModuleBayTypeRequest) MarshalJSON() ([]byte, error) {
...
func (o ModuleBayTypeRequest) ToMap() (map[string]interface{}, error) {
...
func (o *ModuleBayTypeRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varModuleBayTypeRequest := _ModuleBayTypeRequest{}

	err = json.Unmarshal(data, &varModuleBayTypeRequest)

	if err != nil {
		return err
	}

	*o = ModuleBayTypeRequest(varModuleBayTypeRequest)
...
type NullableModuleBayTypeRequest struct {
	value *ModuleBayTypeRequest
	isSet bool
}

func (v NullableModuleBayTypeRequest) Get() *ModuleBayTypeRequest {
	return v.value
}

func (v *NullableModuleBayTypeRequest) Set(val *ModuleBayTypeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableModuleBayTypeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableModuleBayTypeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModuleBayTypeRequest(val *ModuleBayTypeRequest) *NullableModuleBayTypeRequest {
	return &NullableModuleBayTypeRequest{value: val, isSet: true}
}

func (v NullableModuleBayTypeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModuleBayTypeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
