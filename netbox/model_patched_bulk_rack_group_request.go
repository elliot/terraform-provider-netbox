...
func (o *PatchedBulkRackGroupRequest) GetOwner() int32 {
...
func (o *PatchedBulkRackGroupRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkRackGroupRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
