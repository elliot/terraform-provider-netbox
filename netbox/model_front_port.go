...
func NewFrontPort(id int32) *FrontPort {
	this := FrontPort{}
	this.Id = id
	return &this
}
...
func (o *FrontPort) GetType() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *FrontPort) GetTypeOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *FrontPort) SetType(v ChoiceString) {
	o.Type = &v
}
...
func (o *FrontPort) HasLinkPeers() bool {
	if o != nil && !IsNil(o.LinkPeers) {
		return true
	}
