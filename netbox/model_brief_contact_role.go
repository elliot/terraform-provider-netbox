...
func NewBriefContactRole(id int32) *BriefContactRole {
...
func (o *BriefContactRole) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *BriefContactRole) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *BriefContactRole) HasSlug() bool {
	if o != nil && !IsNil(o.Slug) {
		return true
	}
