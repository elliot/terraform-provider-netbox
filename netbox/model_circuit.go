...
type Circuit struct {
	...
	Type            *BriefCircuitType            `json:"type,omitempty"`
...
func NewCircuit(id int32) *Circuit {
	this := Circuit{}
	this.Id = id
	return &this
}
...
func (o *Circuit) HasProvider() bool {
	if o != nil && !IsNil(o.Provider) {
		return true
	}
...
// SetType gets a reference to the given BriefCircuitType and assigns it to the Type field.
func (o *Circuit) SetType(v BriefCircuitType) {
	o.Type = &v
}

// GetStatus returns the Status field value if set, zero value otherwise.
func (o *Circuit) GetStatus() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *Circuit) GetStatusOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *Circuit) SetStatus(v ChoiceString) {
	o.Status = &v
}
...
func (o *Circuit) GetDistanceUnit() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Circuit) GetDistanceUnitOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Circuit) SetDistanceUnit(v ChoiceString) {
