...
type DeviceType struct {
	...
	SubdeviceRole NullableChoiceString `json:"subdevice_role,omitempty"`
	...
	// The date after which this device type is no longer supported by the manufacturer
...
func NewDeviceType(id int32) *DeviceType {
	this := DeviceType{}
	this.Id = id
...
func (o *DeviceType) HasManufacturer() bool {
	if o != nil && !IsNil(o.Manufacturer) {
		return true
	}
...
func (o *DeviceType) HasModel() bool {
	if o != nil && !IsNil(o.Model) {
		return true
	}
...
func (o *DeviceType) GetSubdeviceRole() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *DeviceType) GetSubdeviceRoleOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
// SetSubdeviceRole gets a reference to the given NullableChoiceString and assigns it to the SubdeviceRole field.
func (o *DeviceType) SetSubdeviceRole(v ChoiceString) {
...
func (o *DeviceType) GetAirflow() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *DeviceType) GetAirflowOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DeviceType) SetAirflow(v ChoiceString) {
	o.Airflow.Set(&v)
}
...
func (o *DeviceType) GetCoolingMethod() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *DeviceType) GetCoolingMethodOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DeviceType) GetWeightUnit() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *DeviceType) GetWeightUnitOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DeviceType) SetWeightUnit(v ChoiceString) {
	o.WeightUnit.Set(&v)
}
...
func (o *DeviceType) SetEndOfLifeNil() {
	o.EndOfLife.Set(nil)
}
...
func (o *DeviceType) HasCoolingIntakeTemplateCount() bool {
	if o != nil && !IsNil(o.CoolingIntakeTemplateCount) {
		return true
	}
...
func (o *DeviceType) HasCoolingOutflowTemplateCount() bool {
	if o != nil && !IsNil(o.CoolingOutflowTemplateCount) {
		return true
	}
