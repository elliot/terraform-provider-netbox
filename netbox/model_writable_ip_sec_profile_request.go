...
func NewWritableIPSecProfileRequest(name string, mode string, ikePolicy int32, ipsecPolicy int32) *WritableIPSecProfileRequest {
...
func (o *WritableIPSecProfileRequest) GetOwner() int32 {
...
func (o *WritableIPSecProfileRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableIPSecProfileRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
