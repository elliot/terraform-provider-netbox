...
func (o *PatchedFHRPGroupAssignmentRequest) GetGroup() int32 {
...
func (o *PatchedFHRPGroupAssignmentRequest) GetGroupOk() (*int32, bool) {
	if o == nil || IsNil(o.Group) {
		return nil, false
	}
	return o.Group, true
...
func (o *PatchedFHRPGroupAssignmentRequest) SetGroup(v int32) {
	o.Group = &v
}
