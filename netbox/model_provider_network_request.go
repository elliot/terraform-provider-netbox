...
func NewProviderNetworkRequest(provider int32, name string) *ProviderNetworkRequest {
...
func (o *ProviderNetworkRequest) GetProvider() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o *ProviderNetworkRequest) GetProviderOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ProviderNetworkRequest) SetProvider(v int32) {
	o.Provider = v
}
...
func (o *ProviderNetworkRequest) GetOwner() int32 {
...
func (o *ProviderNetworkRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ProviderNetworkRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
