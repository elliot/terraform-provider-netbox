...
func (o *PatchedBulkProviderNetworkRequest) GetProvider() int32 {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkProviderNetworkRequest) GetProviderOk() (*int32, bool) {
	if o == nil || IsNil(o.Provider) {
		return nil, false
	}
...
func (o *PatchedBulkProviderNetworkRequest) SetProvider(v int32) {
	o.Provider = &v
}
...
func (o *PatchedBulkProviderNetworkRequest) GetOwner() int32 {
...
func (o *PatchedBulkProviderNetworkRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkProviderNetworkRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
