...
func (o *DataSourceRequest) GetSyncInterval() int32 {
...
func (o *DataSourceRequest) GetSyncIntervalOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DataSourceRequest) SetSyncInterval(v int32) {
...
func (o *DataSourceRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *DataSourceRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DataSourceRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
