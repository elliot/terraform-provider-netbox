...
type PaginatedRackTypeList struct {
	...
	Results              []RackType     `json:"results,omitempty"`
...
func NewPaginatedRackTypeList() *PaginatedRackTypeList {
...
func (o *PaginatedRackTypeList) HasCount() bool {
	if o != nil && !IsNil(o.Count) {
		return true
	}
...
func (o *PaginatedRackTypeList) HasResults() bool {
	if o != nil && !IsNil(o.Results) {
		return true
	}
...
// SetResults gets a reference to the given []RackType and assigns it to the Results field.
