...
func (o *BulkCustomLinkRequest) GetButtonClass() string {
...
// and a boolean to check if the value has been set.
func (o *BulkCustomLinkRequest) GetButtonClassOk() (*string, bool) {
	if o == nil || IsNil(o.ButtonClass) {
		return nil, false
	}
...
func (o *BulkCustomLinkRequest) SetButtonClass(v string) {
	o.ButtonClass = &v
}
...
func (o *BulkCustomLinkRequest) GetOwner() int32 {
...
func (o *BulkCustomLinkRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkCustomLinkRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
