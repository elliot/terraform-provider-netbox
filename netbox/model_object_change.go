...
type ObjectChange struct {
	...
	Action               *ChoiceString `json:"action,omitempty"`
	ChangedObjectType    *string       `json:"changed_object_type,omitempty"`
	ChangedObjectId      *int64        `json:"changed_object_id,omitempty"`
...
func NewObjectChange(id int32) *ObjectChange {
	this := ObjectChange{}
	this.Id = id
	return &this
}
...
func (o *ObjectChange) GetAction() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *ObjectChange) GetActionOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Action) {
		return nil, false
	}
...
// SetAction gets a reference to the given ChoiceString and assigns it to the Action field.
func (o *ObjectChange) SetAction(v ChoiceString) {
	o.Action = &v
}
...
func (o *ObjectChange) GetChangedObjectType() string {
	if o == nil || IsNil(o.ChangedObjectType) {
		var ret string
		return ret
	}
...
// GetChangedObjectId returns the ChangedObjectId field value if set, zero value otherwise.
func (o *ObjectChange) GetChangedObjectId() int64 {
	if o == nil || IsNil(o.ChangedObjectId) {
		var ret int64
		return ret
	}
...
// GetChangedObjectIdOk returns a tuple with the ChangedObjectId field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasChangedObjectId returns a boolean if a field has been set.
func (o *ObjectChange) HasChangedObjectId() bool {
	if o != nil && !IsNil(o.ChangedObjectId) {
		return true
	}
...
// SetChangedObjectId gets a reference to the given int64 and assigns it to the ChangedObjectId field.
...
// GetObjectRepr returns the ObjectRepr field value if set, zero value otherwise.
func (o *ObjectChange) GetObjectRepr() string {
	if o == nil || IsNil(o.ObjectRepr) {
		var ret string
		return ret
	}
	return *o.ObjectRepr
...
// GetObjectReprOk returns a tuple with the ObjectRepr field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasObjectRepr returns a boolean if a field has been set.
func (o *ObjectChange) HasObjectRepr() bool {
	if o != nil && !IsNil(o.ObjectRepr) {
		return true
	}
...
// SetObjectRepr gets a reference to the given string and assigns it to the ObjectRepr field.
...
func (o *ObjectChange) HasMessage() bool {
	if o != nil && !IsNil(o.Message) {
		return true
	}
