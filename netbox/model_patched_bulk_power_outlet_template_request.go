...
func (o *PatchedBulkPowerOutletTemplateRequest) GetDeviceType() int32 {
...
func (o *PatchedBulkPowerOutletTemplateRequest) GetDeviceTypeOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkPowerOutletTemplateRequest) SetDeviceType(v int32) {
	o.DeviceType.Set(&v)
}
...
func (o *PatchedBulkPowerOutletTemplateRequest) GetModuleType() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedBulkPowerOutletTemplateRequest) GetModuleTypeOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkPowerOutletTemplateRequest) SetModuleType(v int32) {
	o.ModuleType.Set(&v)
}
...
func (o *PatchedBulkPowerOutletTemplateRequest) GetType() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedBulkPowerOutletTemplateRequest) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkPowerOutletTemplateRequest) SetType(v string) {
	o.Type.Set(&v)
}
...
func (o *PatchedBulkPowerOutletTemplateRequest) GetColor() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkPowerOutletTemplateRequest) GetColorOk() (*string, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *PatchedBulkPowerOutletTemplateRequest) SetColor(v string) {
	o.Color = &v
}

// GetPowerPort returns the PowerPort field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PatchedBulkPowerOutletTemplateRequest) GetPowerPort() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedBulkPowerOutletTemplateRequest) GetPowerPortOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkPowerOutletTemplateRequest) SetPowerPort(v int32) {
	o.PowerPort.Set(&v)
}
...
func (o *PatchedBulkPowerOutletTemplateRequest) GetFeedLeg() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedBulkPowerOutletTemplateRequest) GetFeedLegOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkPowerOutletTemplateRequest) SetFeedLeg(v string) {
	o.FeedLeg.Set(&v)
}
