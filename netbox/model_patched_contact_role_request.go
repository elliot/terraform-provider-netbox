...
func (o *PatchedContactRoleRequest) GetOwner() int32 {
...
func (o *PatchedContactRoleRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedContactRoleRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
