...
func NewRearPortTemplate(id int32) *RearPortTemplate {
...
func (o *RearPortTemplate) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *RearPortTemplate) GetType() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *RearPortTemplate) GetTypeOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *RearPortTemplate) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *RearPortTemplate) SetType(v ChoiceString) {
	o.Type = &v
}
