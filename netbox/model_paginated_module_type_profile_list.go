...
type PaginatedModuleTypeProfileList struct {
	...
	Results              []ModuleTypeProfile `json:"results,omitempty"`
...
func NewPaginatedModuleTypeProfileList() *PaginatedModuleTypeProfileList {
...
func (o *PaginatedModuleTypeProfileList) HasCount() bool {
	if o != nil && !IsNil(o.Count) {
		return true
	}
...
func (o *PaginatedModuleTypeProfileList) HasResults() bool {
	if o != nil && !IsNil(o.Results) {
		return true
	}
...
// SetResults gets a reference to the given []ModuleTypeProfile and assigns it to the Results field.
