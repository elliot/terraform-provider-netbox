...
type PaginatedVLANTranslationPolicyList struct {
	...
	Results              []VLANTranslationPolicy `json:"results,omitempty"`
...
func NewPaginatedVLANTranslationPolicyList() *PaginatedVLANTranslationPolicyList {
...
func (o *PaginatedVLANTranslationPolicyList) HasCount() bool {
	if o != nil && !IsNil(o.Count) {
		return true
	}
...
func (o *PaginatedVLANTranslationPolicyList) HasResults() bool {
	if o != nil && !IsNil(o.Results) {
		return true
	}
...
// SetResults gets a reference to the given []VLANTranslationPolicy and assigns it to the Results field.
