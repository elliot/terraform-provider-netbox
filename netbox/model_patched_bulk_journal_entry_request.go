...
func (o *PatchedBulkJournalEntryRequest) GetKind() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkJournalEntryRequest) GetKindOk() (*string, bool) {
	if o == nil || IsNil(o.Kind) {
		return nil, false
	}
	return o.Kind, true
...
func (o *PatchedBulkJournalEntryRequest) SetKind(v string) {
	o.Kind = &v
}
