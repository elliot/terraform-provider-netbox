...
func (o *PatchedConfigContextRequest) GetProfile() int32 {
...
func (o *PatchedConfigContextRequest) GetProfileOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedConfigContextRequest) SetProfile(v int32) {
	o.Profile.Set(&v)
}
...
func (o *PatchedConfigContextRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedConfigContextRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedConfigContextRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
...
func (o *PatchedConfigContextRequest) GetDataSource() int32 {
...
// and a boolean to check if the value has been set.
func (o *PatchedConfigContextRequest) GetDataSourceOk() (*int32, bool) {
	if o == nil || IsNil(o.DataSource) {
		return nil, false
	}
...
func (o *PatchedConfigContextRequest) SetDataSource(v int32) {
	o.DataSource = &v
}
