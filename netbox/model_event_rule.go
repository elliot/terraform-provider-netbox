...
type EventRule struct {
	...
	ActionType           *ChoiceString          `json:"action_type,omitempty"`
	ActionObjectType     NullableString         `json:"action_object_type,omitempty"`
	ActionObjectId       NullableInt64          `json:"action_object_id,omitempty"`
	ActionObject         interface{}            `json:"action_object,omitempty"`
	ActionIsAvailable    *bool                  `json:"action_is_available,omitempty"`
...
func NewEventRule(id int32) *EventRule {
	this := EventRule{}
	this.Id = id
	return &this
}
...
func (o *EventRule) HasObjectTypes() bool {
	if o != nil && !IsNil(o.ObjectTypes) {
		return true
	}
...
func (o *EventRule) HasEventTypes() bool {
	if o != nil && !IsNil(o.EventTypes) {
		return true
	}
...
func (o *EventRule) GetActionType() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *EventRule) GetActionTypeOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.ActionType) {
		return nil, false
	}
...
func (o *EventRule) HasActionType() bool {
	if o != nil && !IsNil(o.ActionType) {
		return true
	}
...
// SetActionType gets a reference to the given ChoiceString and assigns it to the ActionType field.
func (o *EventRule) SetActionType(v ChoiceString) {
	o.ActionType = &v
}

// GetActionObjectType returns the ActionObjectType field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *EventRule) GetActionObjectType() string {
	if o == nil || IsNil(o.ActionObjectType.Get()) {
		var ret string
		return ret
	}
	return *o.ActionObjectType.Get()
}
...
// SetActionObjectType gets a reference to the given NullableString and assigns it to the ActionObjectType field.
func (o *EventRule) SetActionObjectType(v string) {
	o.ActionObjectType.Set(&v)
}

// SetActionObjectTypeNil sets the value for ActionObjectType to be an explicit nil
func (o *EventRule) SetActionObjectTypeNil() {
	o.ActionObjectType.Set(nil)
}
...
// GetActionIsAvailable returns the ActionIsAvailable field value if set, zero value otherwise.
func (o *EventRule) GetActionIsAvailable() bool {
	if o == nil || IsNil(o.ActionIsAvailable) {
		var ret bool
		return ret
	}
	return *o.ActionIsAvailable
}

// GetActionIsAvailableOk returns a tuple with the ActionIsAvailable field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EventRule) GetActionIsAvailableOk() (*bool, bool) {
	if o == nil || IsNil(o.ActionIsAvailable) {
		return nil, false
	}
	return o.ActionIsAvailable, true
}

// HasActionIsAvailable returns a boolean if a field has been set.
func (o *EventRule) HasActionIsAvailable() bool {
	if o != nil && !IsNil(o.ActionIsAvailable) {
		return true
	}
...
// SetActionIsAvailable gets a reference to the given bool and assigns it to the ActionIsAvailable field.
func (o *EventRule) SetActionIsAvailable(v bool) {
	o.ActionIsAvailable = &v
}
...
func (o EventRule) ToMap() (map[string]interface{}, error) {
	...
	if o.ActionObjectType.IsSet() {
		toSerialize["action_object_type"] = o.ActionObjectType.Get()
	}
	...
	if !IsNil(o.ActionIsAvailable) {
		toSerialize["action_is_available"] = o.ActionIsAvailable
	}
...
func (o *EventRule) UnmarshalJSON(data []byte) (err error) {
	...
	*o = EventRule(varEventRule)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "action_is_available")
