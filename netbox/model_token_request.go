...
func NewTokenRequest(user int32) *TokenRequest {
	this := TokenRequest{}
	this.User = user
	return &this
}
...
func (o *TokenRequest) GetVersion() int32 {
...
func (o *TokenRequest) GetVersionOk() (*int32, bool) {
	if o == nil || IsNil(o.Version) {
		return nil, false
	}
...
func (o *TokenRequest) SetVersion(v int32) {
	o.Version = &v
}
