...
type Cluster struct {
	...
	Type                 *BriefClusterType         `json:"type,omitempty"`
...
func NewCluster(id int32) *Cluster {
	this := Cluster{}
	this.Id = id
	return &this
}
...
// SetType gets a reference to the given BriefClusterType and assigns it to the Type field.
...
func (o *Cluster) GetStatus() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *Cluster) GetStatusOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *Cluster) SetStatus(v ChoiceString) {
	o.Status = &v
}
