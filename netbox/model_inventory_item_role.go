...
func NewInventoryItemRole(id int32) *InventoryItemRole {
...
func (o *InventoryItemRole) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *InventoryItemRole) HasDisplay() bool {
	if o != nil && !IsNil(o.Display) {
		return true
	}
...
func (o *InventoryItemRole) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *InventoryItemRole) HasSlug() bool {
	if o != nil && !IsNil(o.Slug) {
		return true
	}
