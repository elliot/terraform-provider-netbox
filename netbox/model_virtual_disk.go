...
func NewVirtualDisk(id int32) *VirtualDisk {
	this := VirtualDisk{}
	this.Id = id
	return &this
}
...
func (o *VirtualDisk) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *VirtualDisk) HasVirtualMachine() bool {
	if o != nil && !IsNil(o.VirtualMachine) {
		return true
	}
...
func (o *VirtualDisk) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *VirtualDisk) HasSize() bool {
	if o != nil && !IsNil(o.Size) {
		return true
	}
