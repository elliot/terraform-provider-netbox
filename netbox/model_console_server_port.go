...
type ConsoleServerPort struct {
	...
	Speed       NullableChoiceInteger `json:"speed,omitempty"`
...
func NewConsoleServerPort(id int32) *ConsoleServerPort {
...
func (o *ConsoleServerPort) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ConsoleServerPort) GetType() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *ConsoleServerPort) GetTypeOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ConsoleServerPort) GetSpeedOk() (*ChoiceInteger, bool) {
	if o == nil {
		return nil, false
	}
...
// SetSpeed gets a reference to the given NullableChoiceInteger and assigns it to the Speed field.
func (o *ConsoleServerPort) SetSpeed(v ChoiceInteger) {
	o.Speed.Set(&v)
}
...
func (o *ConsoleServerPort) HasLinkPeers() bool {
	if o != nil && !IsNil(o.LinkPeers) {
		return true
	}
...
func (o *ConsoleServerPort) HasConnectedEndpointsReachable() bool {
	if o != nil && !IsNil(o.ConnectedEndpointsReachable) {
		return true
	}
