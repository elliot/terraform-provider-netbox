...
type PatchedBulkWebhookRequest struct {
	...
	// Jinja2 template for a custom request body. If blank, a JSON object representing the change will be included. Available context data includes: <code>event</code>, <code>model</code>, <code>timestamp</code>, <code>request</code>, and <code>data</code>.
	...
	// The maximum time (in seconds) to wait for a response before failing the request. Leave blank to use the system default (60 seconds).
...
func (o *PatchedBulkWebhookRequest) GetHttpMethod() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkWebhookRequest) GetHttpMethodOk() (*string, bool) {
	if o == nil || IsNil(o.HttpMethod) {
		return nil, false
	}
...
func (o *PatchedBulkWebhookRequest) SetHttpMethod(v string) {
	o.HttpMethod = &v
}
...
func (o *PatchedBulkWebhookRequest) SetTimeoutNil() {
	o.Timeout.Set(nil)
}
...
func (o *PatchedBulkWebhookRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedBulkWebhookRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkWebhookRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
