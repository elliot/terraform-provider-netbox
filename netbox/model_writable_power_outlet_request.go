...
func (o *WritablePowerOutletRequest) GetStatus() string {
...
// and a boolean to check if the value has been set.
func (o *WritablePowerOutletRequest) GetStatusOk() (*string, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *WritablePowerOutletRequest) SetStatus(v string) {
	o.Status = &v
}
...
func (o *WritablePowerOutletRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WritablePowerOutletRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritablePowerOutletRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
