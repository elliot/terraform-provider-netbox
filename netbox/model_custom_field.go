...
type CustomField struct {
	...
	FilterLogic  *ChoiceString `json:"filter_logic,omitempty"`
	UiVisible    *ChoiceString `json:"ui_visible,omitempty"`
	UiEditable   *ChoiceString `json:"ui_editable,omitempty"`
	// Replicate this value when cloning objects
	IsCloneable *bool `json:"is_cloneable,omitempty"`
	// Sort null values before non-null values when ordering by this field
...
func NewCustomField(id int32) *CustomField {
	this := CustomField{}
	this.Id = id
	return &this
}
...
func (o *CustomField) HasObjectTypes() bool {
	if o != nil && !IsNil(o.ObjectTypes) {
		return true
	}
...
func (o *CustomField) GetType() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *CustomField) GetTypeOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *CustomField) SetType(v ChoiceString) {
	o.Type = &v
}
...
func (o *CustomField) GetFilterLogic() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *CustomField) GetFilterLogicOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.FilterLogic) {
		return nil, false
	}
...
// SetFilterLogic gets a reference to the given ChoiceString and assigns it to the FilterLogic field.
func (o *CustomField) SetFilterLogic(v ChoiceString) {
	o.FilterLogic = &v
}

// GetUiVisible returns the UiVisible field value if set, zero value otherwise.
func (o *CustomField) GetUiVisible() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *CustomField) GetUiVisibleOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.UiVisible) {
		return nil, false
	}
...
// SetUiVisible gets a reference to the given ChoiceString and assigns it to the UiVisible field.
func (o *CustomField) SetUiVisible(v ChoiceString) {
	o.UiVisible = &v
}

// GetUiEditable returns the UiEditable field value if set, zero value otherwise.
func (o *CustomField) GetUiEditable() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *CustomField) GetUiEditableOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.UiEditable) {
		return nil, false
	}
...
// SetUiEditable gets a reference to the given ChoiceString and assigns it to the UiEditable field.
func (o *CustomField) SetUiEditable(v ChoiceString) {
	o.UiEditable = &v
}
...
// GetNullsFirst returns the NullsFirst field value if set, zero value otherwise.
func (o *CustomField) GetNullsFirst() bool {
	if o == nil || IsNil(o.NullsFirst) {
		var ret bool
		return ret
	}
	return *o.NullsFirst
...
// GetNullsFirstOk returns a tuple with the NullsFirst field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CustomField) GetNullsFirstOk() (*bool, bool) {
	if o == nil || IsNil(o.NullsFirst) {
		return nil, false
	}
	return o.NullsFirst, true
}
...
// SetNullsFirst gets a reference to the given bool and assigns it to the NullsFirst field.
...
func (o *CustomField) GetStatus() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *CustomField) GetStatusOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *CustomField) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *CustomField) SetStatus(v ChoiceString) {
	o.Status = &v
}
...
func (o CustomField) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NullsFirst) {
		toSerialize["nulls_first"] = o.NullsFirst
	}
	if o.Default != nil {
...
func (o *CustomField) UnmarshalJSON(data []byte) (err error) {
	...
	*o = CustomField(varCustomField)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "nulls_first")
