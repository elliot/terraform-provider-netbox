...
type IPAddress struct {
	...
	Family             *ChoiceInteger          `json:"family,omitempty"`
...
func NewIPAddress(id int32) *IPAddress {
	this := IPAddress{}
	this.Id = id
	return &this
}
...
func (o *IPAddress) GetFamily() ChoiceInteger {
...
// and a boolean to check if the value has been set.
func (o *IPAddress) GetFamilyOk() (*ChoiceInteger, bool) {
	if o == nil || IsNil(o.Family) {
		return nil, false
	}
...
// SetFamily gets a reference to the given ChoiceInteger and assigns it to the Family field.
func (o *IPAddress) SetFamily(v ChoiceInteger) {
	o.Family = &v
}
...
func (o *IPAddress) GetStatus() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *IPAddress) GetStatusOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *IPAddress) SetStatus(v ChoiceString) {
	o.Status = &v
}

// GetRole returns the Role field value if set, zero value otherwise.
func (o *IPAddress) GetRole() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *IPAddress) GetRoleOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Role) {
		return nil, false
	}
	return o.Role, true
...
func (o *IPAddress) SetRole(v ChoiceString) {
	o.Role = &v
}
