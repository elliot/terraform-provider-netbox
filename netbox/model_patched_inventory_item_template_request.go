...
func (o *PatchedInventoryItemTemplateRequest) GetDeviceType() int32 {
...
func (o *PatchedInventoryItemTemplateRequest) GetDeviceTypeOk() (*int32, bool) {
	if o == nil || IsNil(o.DeviceType) {
		return nil, false
	}
...
func (o *PatchedInventoryItemTemplateRequest) SetDeviceType(v int32) {
	o.DeviceType = &v
}
...
func (o *PatchedInventoryItemTemplateRequest) GetRole() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedInventoryItemTemplateRequest) GetRoleOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedInventoryItemTemplateRequest) SetRole(v int32) {
	o.Role.Set(&v)
}
...
func (o *PatchedInventoryItemTemplateRequest) GetManufacturer() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedInventoryItemTemplateRequest) GetManufacturerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedInventoryItemTemplateRequest) SetManufacturer(v int32) {
