...
// checks if the PatchedModuleBayTypeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedModuleBayTypeRequest{}

// PatchedModuleBayTypeRequest Base serializer class for models inheriting from PrimaryModel.
type PatchedModuleBayTypeRequest struct {
...
type _PatchedModuleBayTypeRequest PatchedModuleBayTypeRequest
...
func NewPatchedModuleBayTypeRequest() *PatchedModuleBayTypeRequest {
	this := PatchedModuleBayTypeRequest{}
	return &this
}
...
func (o *PatchedModuleBayTypeRequest) GetManufacturer() int32 {
...
func (o *PatchedModuleBayTypeRequest) GetManufacturerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedModuleBayTypeRequest) SetManufacturer(v int32) {
	o.Manufacturer.Set(&v)
}

// SetManufacturerNil sets the value for Manufacturer to be an explicit nil
func (o *PatchedModuleBayTypeRequest) SetManufacturerNil() {
...
func (o *PatchedModuleBayTypeRequest) GetColor() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedModuleBayTypeRequest) GetColorOk() (*string, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *PatchedModuleBayTypeRequest) SetColor(v string) {
	o.Color = &v
}
...
func (o *PatchedModuleBayTypeRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedModuleBayTypeRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedModuleBayTypeRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}

// SetOwnerNil sets the value for Owner to be an explicit nil
func (o *PatchedModuleBayTypeRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedModuleBayTypeRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedModuleBayTypeRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedModuleBayTypeRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedModuleBayTypeRequest := _PatchedModuleBayTypeRequest{}

	err = json.Unmarshal(data, &varPatchedModuleBayTypeRequest)

	if err != nil {
		return err
	}

	*o = PatchedModuleBayTypeRequest(varPatchedModuleBayTypeRequest)
...
type NullablePatchedModuleBayTypeRequest struct {
	value *PatchedModuleBayTypeRequest
	isSet bool
}

func (v NullablePatchedModuleBayTypeRequest) Get() *PatchedModuleBayTypeRequest {
	return v.value
}

func (v *NullablePatchedModuleBayTypeRequest) Set(val *PatchedModuleBayTypeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedModuleBayTypeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedModuleBayTypeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedModuleBayTypeRequest(val *PatchedModuleBayTypeRequest) *NullablePatchedModuleBayTypeRequest {
	return &NullablePatchedModuleBayTypeRequest{value: val, isSet: true}
}

func (v NullablePatchedModuleBayTypeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedModuleBayTypeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
