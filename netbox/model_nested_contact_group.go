...
func NewNestedContactGroup(id int32) *NestedContactGroup {
...
func (o *NestedContactGroup) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *NestedContactGroup) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *NestedContactGroup) HasSlug() bool {
	if o != nil && !IsNil(o.Slug) {
		return true
	}
