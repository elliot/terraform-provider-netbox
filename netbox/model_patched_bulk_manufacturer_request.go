...
func (o *PatchedBulkManufacturerRequest) GetOwner() int32 {
...
func (o *PatchedBulkManufacturerRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkManufacturerRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
