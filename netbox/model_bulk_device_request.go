...
// checks if the BulkDeviceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkDeviceRequest{}

// BulkDeviceRequest Base serializer class for models inheriting from PrimaryModel.
type BulkDeviceRequest struct {
	...
	CoolingMethod  NullableString `json:"cooling_method,omitempty"`
...
type _BulkDeviceRequest BulkDeviceRequest

// NewBulkDeviceRequest instantiates a new BulkDeviceRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewBulkDeviceRequest(id int32, deviceType int32, role int32, site int32) *BulkDeviceRequest {
	this := BulkDeviceRequest{}
	this.Id = id
...
func (o *BulkDeviceRequest) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *BulkDeviceRequest) GetDeviceType() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BulkDeviceRequest) GetDeviceTypeOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkDeviceRequest) SetDeviceType(v int32) {
	o.DeviceType = v
}

// GetRole returns the Role field value
func (o *BulkDeviceRequest) GetRole() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BulkDeviceRequest) GetRoleOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Role, true
...
func (o *BulkDeviceRequest) SetRole(v int32) {
	o.Role = v
}

// GetTenant returns the Tenant field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *BulkDeviceRequest) GetTenant() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkDeviceRequest) GetTenantOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkDeviceRequest) SetTenant(v int32) {
	o.Tenant.Set(&v)
}

// SetTenantNil sets the value for Tenant to be an explicit nil
func (o *BulkDeviceRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *BulkDeviceRequest) GetPlatform() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkDeviceRequest) GetPlatformOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkDeviceRequest) SetPlatform(v int32) {
	o.Platform.Set(&v)
}

// SetPlatformNil sets the value for Platform to be an explicit nil
func (o *BulkDeviceRequest) SetPlatformNil() {
	o.Platform.Set(nil)
}
...
func (o *BulkDeviceRequest) SetAssetTagNil() {
	o.AssetTag.Set(nil)
}
...
func (o *BulkDeviceRequest) GetSite() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BulkDeviceRequest) GetSiteOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Site, true
...
func (o *BulkDeviceRequest) SetSite(v int32) {
	o.Site = v
}

// GetLocation returns the Location field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *BulkDeviceRequest) GetLocation() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkDeviceRequest) GetLocationOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkDeviceRequest) SetLocation(v int32) {
	o.Location.Set(&v)
}

// SetLocationNil sets the value for Location to be an explicit nil
func (o *BulkDeviceRequest) SetLocationNil() {
	o.Location.Set(nil)
}
...
func (o *BulkDeviceRequest) GetRack() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkDeviceRequest) GetRackOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkDeviceRequest) SetRack(v int32) {
	o.Rack.Set(&v)
}

// SetRackNil sets the value for Rack to be an explicit nil
func (o *BulkDeviceRequest) SetRackNil() {
	o.Rack.Set(nil)
}
...
func (o *BulkDeviceRequest) SetPositionNil() {
	o.Position.Set(nil)
}
...
func (o *BulkDeviceRequest) GetFace() string {
...
// and a boolean to check if the value has been set.
func (o *BulkDeviceRequest) GetFaceOk() (*string, bool) {
	if o == nil || IsNil(o.Face) {
		return nil, false
	}
	return o.Face, true
...
func (o *BulkDeviceRequest) SetFace(v string) {
	o.Face = &v
}
...
func (o *BulkDeviceRequest) SetLatitudeNil() {
	o.Latitude.Set(nil)
}
...
func (o *BulkDeviceRequest) SetLongitudeNil() {
	o.Longitude.Set(nil)
}
...
func (o *BulkDeviceRequest) GetStatus() string {
...
// and a boolean to check if the value has been set.
func (o *BulkDeviceRequest) GetStatusOk() (*string, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *BulkDeviceRequest) SetStatus(v string) {
	o.Status = &v
}

// GetAirflow returns the Airflow field value if set, zero value otherwise.
func (o *BulkDeviceRequest) GetAirflow() string {
...
// and a boolean to check if the value has been set.
func (o *BulkDeviceRequest) GetAirflowOk() (*string, bool) {
	if o == nil || IsNil(o.Airflow) {
		return nil, false
	}
...
func (o *BulkDeviceRequest) SetAirflow(v string) {
	o.Airflow = &v
}
...
func (o *BulkDeviceRequest) GetCoolingMethod() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkDeviceRequest) GetCoolingMethodOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// SetCoolingMethod gets a reference to the given NullableString and assigns it to the CoolingMethod field.
func (o *BulkDeviceRequest) SetCoolingMethod(v string) {
	o.CoolingMethod.Set(&v)
}

// SetCoolingMethodNil sets the value for CoolingMethod to be an explicit nil
func (o *BulkDeviceRequest) SetCoolingMethodNil() {
...
func (o *BulkDeviceRequest) GetPrimaryIp4() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkDeviceRequest) GetPrimaryIp4Ok() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkDeviceRequest) SetPrimaryIp4(v int32) {
	o.PrimaryIp4.Set(&v)
}

// SetPrimaryIp4Nil sets the value for PrimaryIp4 to be an explicit nil
func (o *BulkDeviceRequest) SetPrimaryIp4Nil() {
...
func (o *BulkDeviceRequest) GetPrimaryIp6() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkDeviceRequest) GetPrimaryIp6Ok() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkDeviceRequest) SetPrimaryIp6(v int32) {
	o.PrimaryIp6.Set(&v)
}

// SetPrimaryIp6Nil sets the value for PrimaryIp6 to be an explicit nil
func (o *BulkDeviceRequest) SetPrimaryIp6Nil() {
...
func (o *BulkDeviceRequest) GetOobIp() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkDeviceRequest) GetOobIpOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkDeviceRequest) SetOobIp(v int32) {
	o.OobIp.Set(&v)
}

// SetOobIpNil sets the value for OobIp to be an explicit nil
func (o *BulkDeviceRequest) SetOobIpNil() {
	o.OobIp.Set(nil)
}
...
func (o *BulkDeviceRequest) GetCluster() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkDeviceRequest) GetClusterOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkDeviceRequest) SetCluster(v int32) {
	o.Cluster.Set(&v)
}

// SetClusterNil sets the value for Cluster to be an explicit nil
func (o *BulkDeviceRequest) SetClusterNil() {
	o.Cluster.Set(nil)
}
...
func (o *BulkDeviceRequest) GetVirtualChassis() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkDeviceRequest) GetVirtualChassisOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkDeviceRequest) SetVirtualChassis(v int32) {
	o.VirtualChassis.Set(&v)
}

// SetVirtualChassisNil sets the value for VirtualChassis to be an explicit nil
func (o *BulkDeviceRequest) SetVirtualChassisNil() {
...
func (o *BulkDeviceRequest) SetVcPositionNil() {
...
func (o *BulkDeviceRequest) SetVcPriorityNil() {
...
func (o *BulkDeviceRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkDeviceRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkDeviceRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}

// SetOwnerNil sets the value for Owner to be an explicit nil
func (o *BulkDeviceRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o *BulkDeviceRequest) GetConfigTemplate() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkDeviceRequest) GetConfigTemplateOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkDeviceRequest) SetConfigTemplate(v int32) {
	o.ConfigTemplate.Set(&v)
}

// SetConfigTemplateNil sets the value for ConfigTemplate to be an explicit nil
func (o *BulkDeviceRequest) SetConfigTemplateNil() {
...
func (o BulkDeviceRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkDeviceRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkDeviceRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkDeviceRequest := _BulkDeviceRequest{}

	err = json.Unmarshal(data, &varBulkDeviceRequest)

	if err != nil {
		return err
	}

	*o = BulkDeviceRequest(varBulkDeviceRequest)
...
type NullableBulkDeviceRequest struct {
	value *BulkDeviceRequest
	isSet bool
}

func (v NullableBulkDeviceRequest) Get() *BulkDeviceRequest {
	return v.value
}

func (v *NullableBulkDeviceRequest) Set(val *BulkDeviceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkDeviceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkDeviceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkDeviceRequest(val *BulkDeviceRequest) *NullableBulkDeviceRequest {
	return &NullableBulkDeviceRequest{value: val, isSet: true}
}

func (v NullableBulkDeviceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkDeviceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
