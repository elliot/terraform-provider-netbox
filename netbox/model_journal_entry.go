...
type JournalEntry struct {
	...
	Kind                 *ChoiceString          `json:"kind,omitempty"`
...
func NewJournalEntry(id int32) *JournalEntry {
	this := JournalEntry{}
	this.Id = id
	return &this
}
...
func (o *JournalEntry) HasAssignedObjectType() bool {
	if o != nil && !IsNil(o.AssignedObjectType) {
		return true
	}
...
func (o *JournalEntry) HasAssignedObjectId() bool {
	if o != nil && !IsNil(o.AssignedObjectId) {
		return true
	}
...
func (o *JournalEntry) GetKind() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *JournalEntry) GetKindOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Kind) {
		return nil, false
	}
	return o.Kind, true
...
// SetKind gets a reference to the given ChoiceString and assigns it to the Kind field.
func (o *JournalEntry) SetKind(v ChoiceString) {
	o.Kind = &v
}
...
func (o *JournalEntry) HasComments() bool {
	if o != nil && !IsNil(o.Comments) {
		return true
	}
