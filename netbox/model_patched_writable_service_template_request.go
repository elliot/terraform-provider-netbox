...
func (o *PatchedWritableServiceTemplateRequest) SetProtocolNil() {
	o.Protocol.Set(nil)
}
...
func (o *PatchedWritableServiceTemplateRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedWritableServiceTemplateRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableServiceTemplateRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
