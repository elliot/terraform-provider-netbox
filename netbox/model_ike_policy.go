...
type IKEPolicy struct {
	...
	Version              *ChoiceInteger         `json:"version,omitempty"`
	Mode                 *ChoiceString          `json:"mode,omitempty"`
	Proposals            []BriefIKEProposal     `json:"proposals,omitempty"`
...
func NewIKEPolicy(id int32) *IKEPolicy {
	this := IKEPolicy{}
	this.Id = id
	return &this
}
...
func (o *IKEPolicy) GetVersion() ChoiceInteger {
...
// and a boolean to check if the value has been set.
func (o *IKEPolicy) GetVersionOk() (*ChoiceInteger, bool) {
	if o == nil || IsNil(o.Version) {
		return nil, false
	}
...
func (o *IKEPolicy) HasVersion() bool {
	if o != nil && !IsNil(o.Version) {
		return true
	}
...
// SetVersion gets a reference to the given ChoiceInteger and assigns it to the Version field.
func (o *IKEPolicy) SetVersion(v ChoiceInteger) {
	o.Version = &v
}

// GetMode returns the Mode field value if set, zero value otherwise.
func (o *IKEPolicy) GetMode() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *IKEPolicy) GetModeOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Mode) {
		return nil, false
	}
	return o.Mode, true
...
func (o *IKEPolicy) SetMode(v ChoiceString) {
	o.Mode = &v
}
...
// SetProposals gets a reference to the given []BriefIKEProposal and assigns it to the Proposals field.
