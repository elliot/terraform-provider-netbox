...
func (o *VirtualCircuitTypeRequest) GetOwner() int32 {
...
func (o *VirtualCircuitTypeRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VirtualCircuitTypeRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
