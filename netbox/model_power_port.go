...
func NewPowerPort(id int32) *PowerPort {
	this := PowerPort{}
	this.Id = id
	return &this
}
...
func (o *PowerPort) GetType() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PowerPort) GetTypeOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PowerPort) SetType(v ChoiceString) {
	o.Type.Set(&v)
}
...
func (o *PowerPort) HasLinkPeers() bool {
	if o != nil && !IsNil(o.LinkPeers) {
		return true
	}
...
func (o *PowerPort) HasConnectedEndpointsReachable() bool {
	if o != nil && !IsNil(o.ConnectedEndpointsReachable) {
		return true
	}
