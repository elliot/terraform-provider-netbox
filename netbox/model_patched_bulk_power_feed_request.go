...
func (o *PatchedBulkPowerFeedRequest) GetPowerPanel() int32 {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkPowerFeedRequest) GetPowerPanelOk() (*int32, bool) {
	if o == nil || IsNil(o.PowerPanel) {
		return nil, false
	}
...
func (o *PatchedBulkPowerFeedRequest) SetPowerPanel(v int32) {
	o.PowerPanel = &v
}

// GetRack returns the Rack field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PatchedBulkPowerFeedRequest) GetRack() int32 {
...
func (o *PatchedBulkPowerFeedRequest) GetRackOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkPowerFeedRequest) SetRack(v int32) {
	o.Rack.Set(&v)
}
...
func (o *PatchedBulkPowerFeedRequest) GetStatus() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkPowerFeedRequest) GetStatusOk() (*string, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *PatchedBulkPowerFeedRequest) SetStatus(v string) {
	o.Status = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *PatchedBulkPowerFeedRequest) GetType() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkPowerFeedRequest) GetTypeOk() (*string, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *PatchedBulkPowerFeedRequest) SetType(v string) {
	o.Type = &v
}

// GetSupply returns the Supply field value if set, zero value otherwise.
func (o *PatchedBulkPowerFeedRequest) GetSupply() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkPowerFeedRequest) GetSupplyOk() (*string, bool) {
	if o == nil || IsNil(o.Supply) {
		return nil, false
	}
...
func (o *PatchedBulkPowerFeedRequest) SetSupply(v string) {
	o.Supply = &v
}

// GetPhase returns the Phase field value if set, zero value otherwise.
func (o *PatchedBulkPowerFeedRequest) GetPhase() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkPowerFeedRequest) GetPhaseOk() (*string, bool) {
	if o == nil || IsNil(o.Phase) {
		return nil, false
	}
	return o.Phase, true
...
func (o *PatchedBulkPowerFeedRequest) SetPhase(v string) {
	o.Phase = &v
}
...
func (o *PatchedBulkPowerFeedRequest) GetTenant() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedBulkPowerFeedRequest) GetTenantOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkPowerFeedRequest) SetTenant(v int32) {
	o.Tenant.Set(&v)
}
...
func (o *PatchedBulkPowerFeedRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedBulkPowerFeedRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkPowerFeedRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
