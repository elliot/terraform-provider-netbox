...
type L2VPN struct {
	...
	ImportTargets        []BriefRouteTarget     `json:"import_targets,omitempty"`
	ExportTargets        []BriefRouteTarget     `json:"export_targets,omitempty"`
...
func (o *L2VPN) GetType() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *L2VPN) GetTypeOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *L2VPN) SetType(v ChoiceString) {
	o.Type = &v
}

// GetStatus returns the Status field value if set, zero value otherwise.
func (o *L2VPN) GetStatus() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *L2VPN) GetStatusOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *L2VPN) SetStatus(v ChoiceString) {
	o.Status = &v
}
...
// SetImportTargets gets a reference to the given []BriefRouteTarget and assigns it to the ImportTargets field.
...
// SetExportTargets gets a reference to the given []BriefRouteTarget and assigns it to the ExportTargets field.
