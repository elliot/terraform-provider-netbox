...
func NewExportTemplate(id int32) *ExportTemplate {
	this := ExportTemplate{}
	this.Id = id
	return &this
}
...
func (o *ExportTemplate) HasObjectTypes() bool {
	if o != nil && !IsNil(o.ObjectTypes) {
		return true
	}
...
func (o *ExportTemplate) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ExportTemplate) HasTemplateCode() bool {
	if o != nil && !IsNil(o.TemplateCode) {
		return true
	}
