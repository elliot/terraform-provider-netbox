...
func NewServiceTemplate(id int32) *ServiceTemplate {
...
func (o *ServiceTemplate) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *ServiceTemplate) GetProtocol() ChoiceString {
...
func (o *ServiceTemplate) GetProtocolOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ServiceTemplate) SetProtocol(v ChoiceString) {
	o.Protocol.Set(&v)
}
