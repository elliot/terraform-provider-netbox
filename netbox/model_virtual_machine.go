...
type VirtualMachine struct {
	...
	StartOnBoot        *ChoiceString                   `json:"start_on_boot,omitempty"`
...
func NewVirtualMachine(id int32) *VirtualMachine {
	this := VirtualMachine{}
	this.Id = id
	return &this
}
...
func (o *VirtualMachine) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *VirtualMachine) HasDisplay() bool {
	if o != nil && !IsNil(o.Display) {
		return true
	}
...
func (o *VirtualMachine) GetStatus() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *VirtualMachine) GetStatusOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *VirtualMachine) SetStatus(v ChoiceString) {
	o.Status = &v
}

// GetStartOnBoot returns the StartOnBoot field value if set, zero value otherwise.
func (o *VirtualMachine) GetStartOnBoot() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *VirtualMachine) GetStartOnBootOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.StartOnBoot) {
		return nil, false
	}
...
// SetStartOnBoot gets a reference to the given ChoiceString and assigns it to the StartOnBoot field.
func (o *VirtualMachine) SetStartOnBoot(v ChoiceString) {
	o.StartOnBoot = &v
}
...
func (o *VirtualMachine) HasVirtualDiskCount() bool {
	if o != nil && !IsNil(o.VirtualDiskCount) {
		return true
	}
