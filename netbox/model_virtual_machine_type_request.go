...
func (o *VirtualMachineTypeRequest) GetDefaultPlatform() int32 {
...
func (o *VirtualMachineTypeRequest) GetDefaultPlatformOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VirtualMachineTypeRequest) SetDefaultPlatform(v int32) {
...
func (o *VirtualMachineTypeRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *VirtualMachineTypeRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VirtualMachineTypeRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
