...
func (o *PatchedVirtualMachineTypeRequest) GetDefaultPlatform() int32 {
...
func (o *PatchedVirtualMachineTypeRequest) GetDefaultPlatformOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedVirtualMachineTypeRequest) SetDefaultPlatform(v int32) {
...
func (o *PatchedVirtualMachineTypeRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedVirtualMachineTypeRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedVirtualMachineTypeRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
