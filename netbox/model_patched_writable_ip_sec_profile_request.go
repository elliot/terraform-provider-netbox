...
func (o *PatchedWritableIPSecProfileRequest) GetOwner() int32 {
...
func (o *PatchedWritableIPSecProfileRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableIPSecProfileRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
