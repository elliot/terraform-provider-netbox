...
func NewInventoryItem(id int32) *InventoryItem {
	this := InventoryItem{}
	this.Id = id
	return &this
}
...
func (o *InventoryItem) HasDevice() bool {
	if o != nil && !IsNil(o.Device) {
		return true
	}
...
func (o *InventoryItem) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *InventoryItem) GetStatus() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *InventoryItem) GetStatusOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *InventoryItem) SetStatus(v ChoiceString) {
	o.Status = &v
}
