...
type VLANTranslationPolicy struct {
	...
	Rules                []VLANTranslationRule `json:"rules,omitempty"`
...
func NewVLANTranslationPolicy(id int32) *VLANTranslationPolicy {
...
func (o *VLANTranslationPolicy) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *VLANTranslationPolicy) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *VLANTranslationPolicy) HasRules() bool {
	if o != nil && !IsNil(o.Rules) {
		return true
	}
...
// SetRules gets a reference to the given []VLANTranslationRule and assigns it to the Rules field.
