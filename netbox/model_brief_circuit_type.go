...
func NewBriefCircuitType(id int32) *BriefCircuitType {
...
func (o *BriefCircuitType) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *BriefCircuitType) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *BriefCircuitType) HasSlug() bool {
	if o != nil && !IsNil(o.Slug) {
		return true
	}
