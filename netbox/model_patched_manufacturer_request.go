...
func (o *PatchedManufacturerRequest) GetOwner() int32 {
...
func (o *PatchedManufacturerRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedManufacturerRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
