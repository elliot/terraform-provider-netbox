...
func (o *ASNRequest) GetRir() int32 {
...
func (o *ASNRequest) GetRirOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ASNRequest) SetRir(v int32) {
	o.Rir.Set(&v)
}
...
func (o *ASNRequest) GetRole() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ASNRequest) GetRoleOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ASNRequest) SetRole(v int32) {
	o.Role.Set(&v)
}
...
func (o *ASNRequest) GetTenant() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ASNRequest) GetTenantOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ASNRequest) SetTenant(v int32) {
	o.Tenant.Set(&v)
}
...
func (o *ASNRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ASNRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ASNRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
