...
type CableTermination struct {
	...
	TerminationId        *int32        `json:"termination_id,omitempty"`
...
func NewCableTermination(id int32) *CableTermination {
...
func (o *CableTermination) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *CableTermination) HasCable() bool {
	if o != nil && !IsNil(o.Cable) {
		return true
	}
...
func (o *CableTermination) HasTerminationType() bool {
	if o != nil && !IsNil(o.TerminationType) {
		return true
	}
...
func (o *CableTermination) HasTerminationId() bool {
	if o != nil && !IsNil(o.TerminationId) {
		return true
	}
...
// SetTerminationId gets a reference to the given int32 and assigns it to the TerminationId field.
