...
type CustomFieldChoiceSet struct {
	...
	BaseChoices  NullableChoiceString `json:"base_choices,omitempty"`
...
func NewCustomFieldChoiceSet(id int32) *CustomFieldChoiceSet {
...
func (o *CustomFieldChoiceSet) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *CustomFieldChoiceSet) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *CustomFieldChoiceSet) GetBaseChoices() ChoiceString {
...
func (o *CustomFieldChoiceSet) GetBaseChoicesOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
// SetBaseChoices gets a reference to the given NullableChoiceString and assigns it to the BaseChoices field.
func (o *CustomFieldChoiceSet) SetBaseChoices(v ChoiceString) {
	o.BaseChoices.Set(&v)
}
...
func (o *CustomFieldChoiceSet) GetChoiceColors() map[string]string {
...
// and a boolean to check if the value has been set.
func (o *CustomFieldChoiceSet) GetChoiceColorsOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.ChoiceColors) {
		return nil, false
	}
...
func (o *CustomFieldChoiceSet) SetChoiceColors(v map[string]string) {
	o.ChoiceColors = &v
}
