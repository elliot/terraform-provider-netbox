...
type WirelessLink struct {
	...
	InterfaceA           *BriefInterface        `json:"interface_a,omitempty"`
	InterfaceB           *BriefInterface        `json:"interface_b,omitempty"`
	Ssid                 *string                `json:"ssid,omitempty"`
	Status               *ChoiceString          `json:"status,omitempty"`
	Tenant               NullableBriefTenant    `json:"tenant,omitempty"`
	AuthType             *ChoiceString          `json:"auth_type,omitempty"`
	AuthCipher           *ChoiceString          `json:"auth_cipher,omitempty"`
	AuthPsk              *string                `json:"auth_psk,omitempty"`
	Distance             NullableFloat64        `json:"distance,omitempty"`
	DistanceUnit         NullableChoiceString   `json:"distance_unit,omitempty"`
...
func NewWirelessLink(id int32) *WirelessLink {
	this := WirelessLink{}
	this.Id = id
	return &this
}
...
func (o *WirelessLink) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *WirelessLink) HasInterfaceA() bool {
	if o != nil && !IsNil(o.InterfaceA) {
		return true
	}
...
// SetInterfaceA gets a reference to the given BriefInterface and assigns it to the InterfaceA field.
...
func (o *WirelessLink) HasInterfaceB() bool {
	if o != nil && !IsNil(o.InterfaceB) {
		return true
	}
...
// SetInterfaceB gets a reference to the given BriefInterface and assigns it to the InterfaceB field.
...
func (o *WirelessLink) GetStatus() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *WirelessLink) GetStatusOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *WirelessLink) SetStatus(v ChoiceString) {
	o.Status = &v
}
...
func (o *WirelessLink) GetAuthType() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *WirelessLink) GetAuthTypeOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.AuthType) {
		return nil, false
	}
...
// SetAuthType gets a reference to the given ChoiceString and assigns it to the AuthType field.
func (o *WirelessLink) SetAuthType(v ChoiceString) {
	o.AuthType = &v
}

// GetAuthCipher returns the AuthCipher field value if set, zero value otherwise.
func (o *WirelessLink) GetAuthCipher() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *WirelessLink) GetAuthCipherOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.AuthCipher) {
		return nil, false
	}
...
// SetAuthCipher gets a reference to the given ChoiceString and assigns it to the AuthCipher field.
func (o *WirelessLink) SetAuthCipher(v ChoiceString) {
	o.AuthCipher = &v
}
...
func (o *WirelessLink) GetDistanceUnit() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WirelessLink) GetDistanceUnitOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
// SetDistanceUnit gets a reference to the given NullableChoiceString and assigns it to the DistanceUnit field.
func (o *WirelessLink) SetDistanceUnit(v ChoiceString) {
