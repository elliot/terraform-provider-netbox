...
func (o *ExportTemplateRequest) GetDataSource() int32 {
...
// and a boolean to check if the value has been set.
func (o *ExportTemplateRequest) GetDataSourceOk() (*int32, bool) {
	if o == nil || IsNil(o.DataSource) {
		return nil, false
	}
...
func (o *ExportTemplateRequest) SetDataSource(v int32) {
	o.DataSource = &v
}

// GetOwner returns the Owner field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ExportTemplateRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ExportTemplateRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ExportTemplateRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
