...
func NewMACAddress(id int32) *MACAddress {
	this := MACAddress{}
	this.Id = id
	return &this
}
...
func (o *MACAddress) HasMacAddress() bool {
	if o != nil && !IsNil(o.MacAddress) {
		return true
	}
...
func (o *MACAddress) GetIsPrimary() bool {
...
// and a boolean to check if the value has been set.
func (o *MACAddress) GetIsPrimaryOk() (*bool, bool) {
	if o == nil || IsNil(o.IsPrimary) {
		return nil, false
	}
...
func (o *MACAddress) HasIsPrimary() bool {
	if o != nil && !IsNil(o.IsPrimary) {
		return true
	}
...
func (o *MACAddress) SetIsPrimary(v bool) {
	o.IsPrimary = &v
}
