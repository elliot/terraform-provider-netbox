...
func (o *PatchedBulkIKEProposalRequest) GetAuthenticationMethod() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkIKEProposalRequest) GetAuthenticationMethodOk() (*string, bool) {
	if o == nil || IsNil(o.AuthenticationMethod) {
		return nil, false
	}
...
func (o *PatchedBulkIKEProposalRequest) SetAuthenticationMethod(v string) {
	o.AuthenticationMethod = &v
}

// GetEncryptionAlgorithm returns the EncryptionAlgorithm field value if set, zero value otherwise.
func (o *PatchedBulkIKEProposalRequest) GetEncryptionAlgorithm() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkIKEProposalRequest) GetEncryptionAlgorithmOk() (*string, bool) {
	if o == nil || IsNil(o.EncryptionAlgorithm) {
		return nil, false
	}
...
func (o *PatchedBulkIKEProposalRequest) SetEncryptionAlgorithm(v string) {
...
func (o *PatchedBulkIKEProposalRequest) GetAuthenticationAlgorithm() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkIKEProposalRequest) GetAuthenticationAlgorithmOk() (*string, bool) {
	if o == nil || IsNil(o.AuthenticationAlgorithm) {
		return nil, false
	}
...
func (o *PatchedBulkIKEProposalRequest) SetAuthenticationAlgorithm(v string) {
	o.AuthenticationAlgorithm = &v
}

// GetGroup returns the Group field value if set, zero value otherwise.
func (o *PatchedBulkIKEProposalRequest) GetGroup() int32 {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkIKEProposalRequest) GetGroupOk() (*int32, bool) {
	if o == nil || IsNil(o.Group) {
		return nil, false
	}
	return o.Group, true
...
func (o *PatchedBulkIKEProposalRequest) SetGroup(v int32) {
	o.Group = &v
}
...
func (o *PatchedBulkIKEProposalRequest) GetOwner() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedBulkIKEProposalRequest) GetOwnerOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkIKEProposalRequest) SetOwner(v int32) {
	o.Owner.Set(&v)
}
