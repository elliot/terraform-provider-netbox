...
type Device struct {
	...
	CoolingIntakeCount     *int32                 `json:"cooling_intake_count,omitempty"`
	CoolingOutflowCount    *int32                 `json:"cooling_outflow_count,omitempty"`
...
func (o *Device) GetFace() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *Device) GetFaceOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Face) {
		return nil, false
	}
	return o.Face, true
...
func (o *Device) SetFace(v ChoiceString) {
	o.Face = &v
}
...
func (o *Device) GetStatus() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *Device) GetStatusOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *Device) SetStatus(v ChoiceString) {
	o.Status = &v
}

// GetAirflow returns the Airflow field value if set, zero value otherwise.
func (o *Device) GetAirflow() ChoiceString {
...
// and a boolean to check if the value has been set.
func (o *Device) GetAirflowOk() (*ChoiceString, bool) {
	if o == nil || IsNil(o.Airflow) {
		return nil, false
	}
...
func (o *Device) SetAirflow(v ChoiceString) {
	o.Airflow = &v
}
...
func (o *Device) GetCoolingMethod() ChoiceString {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Device) GetCoolingMethodOk() (*ChoiceString, bool) {
	if o == nil {
		return nil, false
	}
...
// GetCoolingIntakeCount returns the CoolingIntakeCount field value if set, zero value otherwise.
func (o *Device) GetCoolingIntakeCount() int32 {
	if o == nil || IsNil(o.CoolingIntakeCount) {
		var ret int32
		return ret
	}
	return *o.CoolingIntakeCount
}

// GetCoolingIntakeCountOk returns a tuple with the CoolingIntakeCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Device) GetCoolingIntakeCountOk() (*int32, bool) {
	if o == nil || IsNil(o.CoolingIntakeCount) {
		return nil, false
	}
	return o.CoolingIntakeCount, true
}

// HasCoolingIntakeCount returns a boolean if a field has been set.
func (o *Device) HasCoolingIntakeCount() bool {
	if o != nil && !IsNil(o.CoolingIntakeCount) {
		return true
	}
...
// SetCoolingIntakeCount gets a reference to the given int32 and assigns it to the CoolingIntakeCount field.
func (o *Device) SetCoolingIntakeCount(v int32) {
	o.CoolingIntakeCount = &v
}

// GetCoolingOutflowCount returns the CoolingOutflowCount field value if set, zero value otherwise.
func (o *Device) GetCoolingOutflowCount() int32 {
	if o == nil || IsNil(o.CoolingOutflowCount) {
		var ret int32
		return ret
	}
	return *o.CoolingOutflowCount
}

// GetCoolingOutflowCountOk returns a tuple with the CoolingOutflowCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Device) GetCoolingOutflowCountOk() (*int32, bool) {
	if o == nil || IsNil(o.CoolingOutflowCount) {
		return nil, false
	}
	return o.CoolingOutflowCount, true
}

// HasCoolingOutflowCount returns a boolean if a field has been set.
func (o *Device) HasCoolingOutflowCount() bool {
	if o != nil && !IsNil(o.CoolingOutflowCount) {
		return true
	}
...
// SetCoolingOutflowCount gets a reference to the given int32 and assigns it to the CoolingOutflowCount field.
func (o *Device) SetCoolingOutflowCount(v int32) {
	o.CoolingOutflowCount = &v
}
...
func (o Device) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CoolingIntakeCount) {
		toSerialize["cooling_intake_count"] = o.CoolingIntakeCount
	}
	if !IsNil(o.CoolingOutflowCount) {
		toSerialize["cooling_outflow_count"] = o.CoolingOutflowCount
	}
...
func (o *Device) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Device(varDevice)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "cooling_intake_count")
		delete(additionalProperties, "cooling_outflow_count")
